...
| Este hechizo permitirá al con<br>mientos de un individuo. Una<br>este conjuro puede doblar el nú<br>asalto, así como duplicar su rang<br>volando, nadando, corriendo, e<br>un conjurador afectado por est<br>gún caso lanzar más de un con<br>de este sortilegio no son acumu<br>El reverso de este conjuro, rale<br>rango de movimiento de la criat<br>ataques que puede realizar.<br>Adivinación (clérigo nivel<br>tl: 10 min AlCAnCe: ve | jurador acele<br>criatura bajo<br>mero de sus<br>o de movimi<br>scalando, etc.<br>e hechizo no<br>juro por asalt<br>lativos.<br>ntizar, reduce<br>ura afectada y<br>4)<br>r texto CoMp | rar lo<br>los ef<br>ataque<br>ento, i<br>Sin e<br>podrá<br>o. Los<br>a la<br>el nú<br>onente |
| duraCión: ver texto ts: no |  | rC: n |
| El lanzador podrá emplear este<br>traer información sobre un aco<br>ocurra a una semana vista. La in<br>ma de consejo, proporcionado p<br>el conjurador. Generalmente, e<br>en una frase, muchas veces algo<br>do, oscura y enigmática, tal vez<br>Adoptar apariencia (il<br>tl: 1 AlCAnCe: 15 | poderoso co<br>ntecimiento<br>formación se<br>or los dioses<br>ste consejo ll<br>críptica o co<br>incluso un ac<br>usionista niv<br>metros CoMp | njuro<br>que se<br>recibe<br>a los q<br>ega co<br>n dob<br>ertijo.<br>el 4)<br>onente |
| duraCión: 12 horas ts: ver te | xto | rC: n |
...
| Gracias a este<br>deidad para q<br>o criaturas ext<br>hasta 16 dados<br>da. El lanzado<br>la deidad pued<br>atendiendo el<br>el lanzador, es<br>vocadas que ll<br>combatir, per<br>tarea requerid<br>Aliento d<br>tl: 1 | conjur<br>ue esta le<br>raplana<br>de golp<br>r podrá<br>e escoge<br>ruego es<br>te podrá<br>even a c<br>o puede<br>a, la cria<br>e dra | o, el lanzado<br>envíe ayuda<br>res. El conjur<br>e de criaturas<br>pedir una cr<br>r entre las di<br>pecífico de s<br>requerir a la<br>abo una dete<br>que según<br>tura o criatu<br>gón (ilusion<br>AlCAnCe: 50 me | r podrá inte<br>en forma de<br>ador podrá<br>que acudirá<br>iatura determ<br>sponibles a v<br>u servidor. U<br>criatura o cr<br>rminada acci<br>las circunsta<br>ras pidan alg<br>ista nivel 5<br>tros CoMpon |
| duraCión: instan | táneo | ts: INT nieg | a r |
...
| El lanzador puede copiar la<br>mismo tipo de forma que la s<br>ganará ataques y habilidade<br>o visión en la oscuridad. N<br>mágica, como, por ejemplo,<br>una medusa.<br>Amistad animal (druid<br>tl: 1 min AlCAnCe: | forma de un<br>uya propia.<br>s especiales c<br>o ganará ni<br>la capacidad<br>a nivel 1)<br>15 metros C | a cria<br>De dic<br>omo<br>nguna<br>de p<br>oMpon | tura con el<br>ha criatura<br>infravisión<br>habilidad<br>etrificar de<br>entes: V y S |
| duraCión: permanente ts: CA | R niega | r | C: sí |
| Gracias a este conjuro, el lanz<br>de un animal. La amistad de<br>naturaleza mágica, y perdurar<br>animal tiene derecho a una tir<br>evitar los efectos del hechizo.<br>de 3 a 6 trucos al animal, a<br>todo, el animal seguirá siend<br>inteligencia tras ser afectado<br>te, defenderá al lanzador ante<br>Animal mensajero (dru<br>tl: 1 AlCAnCe: | ador puede g<br>l animal será<br>á en el tiemp<br>ada de salvac<br>El conjurad<br>discreción d<br>o un anima<br>por este sorti<br>el ataque de<br>ida nivel 2)<br>15 metros C | anarse<br>natu<br>o. Sin<br>ión d<br>or po<br>el Nar<br>l, y no<br>legio.<br>otros<br>oMpon | la amistad<br>ral y no de<br>embargo, el<br>e CAR para<br>drá enseñar<br>rador. Con<br>ganará en<br>No obstan-<br>animales.<br>entes: V y S |
| duraCión: 1 día/nivel ts | : no | r | C: sí |
| El lanzador podrá hechizar a<br>para que transporte un peque<br>El animal solo puede llevarlo<br>el lanzador y que no se encue<br>Narrador según el tipo de an<br>la localización y esperará allí<br>Antipatía/simpatía<br>9, ilusionista nivel 8, mago<br>tl: 1 AlCAnCe: | un pequeño<br>ño objeto o u<br>a un lugar b<br>ntre muy lejo<br>imal). El ani<br>hasta que ex<br>(clérigo nive<br>nivel 8)<br>20 metros C | anima<br>n men<br>ien co<br>s (a dis<br>mal v<br>pire el<br>l 9, d<br>oMpon | l de la zona<br>saje escrito.<br>nocido por<br>creción del<br>iajará hasta<br>conjuro.<br>ruida nivel<br>entes: V y S |
| duraCión: 2 horas/nivel ts: CA | R niega | r | C: sí |
...
| Mediante este conjuro el lanzado<br>tipo de cerradura o cancela a la q<br>puerta que esté cerrada, ya sea por<br>nales o con el concurso de la mag<br>este conjuro. Asimismo, también<br>abrir puertas secretas u otros com<br>cluso si están bloqueados por una<br>y siempre que hayan sido detectad<br>Cerradura es el equivalente inverso<br>puede bloquear una puerta, cofre<br>de forma que no pueda abrirse po<br>lanzador podrá abrir el elemento<br>afectar al conjuro de cerradura.<br>Aprisionar/liberar (mago<br>tl: 1 AlCAnCe: toq | r podrá abr<br>ue se enfrent<br>medios físico<br>ia, podrá ab<br>podrá ser em<br>partimentos s<br>barra de mad<br>os previamen<br>de apertura.<br>o contened<br>r métodos m<br>cerrado mági<br>nivel 9)<br>ue CoMpo |
| duraCión: permanente ts: no | r |
...
| Este conjuro cre<br>otorga un +1 de<br>atacantes que su<br>ran esa bonifica<br>cional de CA n<br>mágicos (por ob<br>Asesino fan<br>tl: 1 | a la i<br>CA<br>peren<br>ción.<br>o se<br>jetos<br>tas | lusión de u<br>al blanco t<br>una tirada<br>En cualqui<br>puede acum<br>mágicos, o<br>ma (ilusio<br>AlCAnCe: 15 | na ar<br>ocado<br>de sa<br>er cas<br>ular<br>tros co<br>nista<br>metros | madura<br>por el<br>lvación<br>o, el bo<br>a otros<br>njuros,<br>nivel 4<br>CoMp | de placas que<br>lanzador. Los<br>de INT igno-<br>nificador adi-<br>bonificadores<br>etc.).<br>)<br>onentes: V y S |
| duraCión: 1 asalto /n | ivel | ts: ver te | xto |  | rC: sí |
...
| duraCión: permanente | ts | : no r |
| Este hechizo extrae<br>la encierra en una<br>La víctima debe ha<br>nivel de lanzador.<br>gema, no se puede<br>a los muertos, res<br>cluso mediante un<br>gema puede liberar<br>Atemorizar (<br>tl: 2 | el alma d<br>gema (de<br>ber falleci<br>Una vez q<br>devolver<br>urrección,<br>milagro o<br>el alma.<br>ilusionist<br>AlCAnC | e una criatura recié<br>al menos 5.000 m<br>do no hace más de<br>ue el alma está con<br>a la vida mediante c<br>resurrección verda<br>uso de deseo. Solo<br>a nivel 7)<br>e: ver texto CoMpon |
| duraCión: ver texto | ts: v | er texto r |
| Mediante este con<br>contra aquellos qu<br>pueda ver al conju<br>a sufrir náuseas, do<br>un punto en todas<br>sará a considerar t<br>en cualquier tirad<br>El conjuro, y cual<br>la criatura afectad<br>o solo durante tres<br>tirada de salvación<br>Atontar (ilusi<br>tl: 1 | juro, el l<br>e le desea<br>rador y qu<br>lor corpor<br>sus caract<br>odas sus c<br>a o salvaci<br>quier pér<br>a siga dese<br>asaltos si<br>de INT.<br>onista ni<br>AlCAnCe | anzador parece em<br>n algún mal. Toda c<br>e desee hacerle dañ<br>al y una pérdida te<br>erísticas. Además, t<br>aracterísticas como<br>ón que involucre<br>dida asociada, dura<br>ando hacer daño<br>la criatura tiene é<br>vel 6, mago nivel<br>: 40 metros CoMpon |
| duraCión: ver texto | ts: C | AR niega r |
| Este hechizo drena<br>razonamiento e inc<br>inteligencia del blan<br>mal. Aun así, inclus<br>del hechizo puede<br>puede seguirlos y pr<br>víctima permanece<br>tablecimiento, deseo<br>Atrapar el a<br>8, mago nivel 8)<br>tl: 1 | el intelect<br>luso la as<br>co a 2, po<br>o con una<br>reconocer<br>otegerlos d<br>en este esta<br>u otro co<br>lma (clé<br>AlCAnCe | o del objetivo, su c<br>tucia más básica, re<br>r debajo incluso de l<br>inteligencia tan baja<br>instintivamente a s<br>e una manera muy p<br>do hasta que se utili<br>njuro equivalente pa<br>rigo nivel 9, ilusio<br>: 15 metros CoMpon |
| duraCión: permanente | ts: C | AR niega r |
...
| Este particular<br>solo a él– obten<br>pronosticando<br>malos resultado<br>provechosa es d<br>El Narrador de<br>La respuesta ge<br>sí, no, si y no o<br>conjuro solo p<br>futuro, cualquie<br>temporal queda<br>lidades que aba<br>a discreción del<br>Aura indet<br>tl: 1 | conjuro adivin<br>er alguna noc<br>si una determ<br>s. La probabili<br>el 70% más 1<br>bería realizar e<br>neralmente se<br>nada (sin res<br>uede abarcar l<br>r acontecimie<br>fuera del escr<br>rca este conjur<br>Narrador.<br>ectable (il<br>AlCAnC | atorio permite a<br>ión sobre el fut<br>inada acción tra<br>dad de obtener<br>% por cada nivel<br>sta tirada de ma<br>formulará con<br>puesta). De todo<br>as dos horas pr<br>nto posterior a<br>utinio del conjur<br>o son muy amp<br>usionista nivel<br>e: toque CoMp | l lanzador –y<br>uro próximo,<br>erá buenos o<br>una respuesta<br>del lanzador.<br>nera discreta.<br>monosílabos:<br>s modos, este<br>óximas en el<br>esta horquilla<br>o. Las posibi-<br>lias y quedan<br>1)<br>onentes: V y S |
| duraCión: perman | ente ts: | no | rC: sí |
| Este hechizo pe<br>objeto mágico p<br>go, un hechizo<br>naturaleza del o<br>de pesar más de<br>Aura mágic<br>tl: 1 | rmite al lanza<br>ara que no pu<br>de identificar<br>bjeto. El objet<br>2,5 kilos por<br>a (ilusionista<br>AlCAnC | dor enmascarar<br>eda ser detectad<br>o similar revelar<br>o blanco del co<br>nivel del lanzad<br>nivel 0)<br>e: toque CoMp | el aura de un<br>o. Sin embar-<br>á la verdadera<br>njuro no pue-<br>or.<br>onentes: V y S |
| duraCión: perman | ente ts: | no | rC: sí |
...
| Para usar est<br>sobre el que<br>anillo, un br<br>magia y tiene<br>morada del c<br>mando. El la<br>te a una cri<br>barrera<br>tl: 1 | e conjur<br>invocar<br>oche, etc.<br>la capac<br>onjurado<br>nzador d<br>atura en<br>de cuc | o, el lanzad<br>las fuerzas<br>A partir del<br>idad de tele<br>r, siempre q<br>ebe entrega<br>concreto y<br>b<br>hillas (clé<br>AlCAnCe: 50 m | or ha de e<br>arcanas: un<br>momento,<br>portar al po<br>ue pronunc<br>r el objeto<br>revelarle di<br>rigo nivel<br>etros CoM |
| duraCión: 3 asa | ltos/nivel | ts: DES ni | ega |
| Este conjuro<br>designado p<br>te atravesar l<br>daño. El pla<br>o vertical a<br>esté dentro d<br>realizar una t<br>pada. El tam<br>varía desde 1<br>bastón c<br>tl: 1 | crea un<br>or el lan<br>a barrera<br>no de rot<br>elección<br>e la barr<br>irada de<br>año de<br>metro c<br>ambian | muro de cuc<br>zador. Cua<br>de cuchill<br>ación de la<br>del lanzado<br>era cuando<br>salvación de<br>la barrera, a<br>uadrado has<br>te (druida<br>AlCAnCe: to | hillas afilad<br>lquier criat<br>as sufrirá 1<br>s cuchillas<br>r. Cualqui<br>esta sea co<br>DES para<br>elección<br>ta 6 metros<br>nivel 7)<br>que CoM |
| duraCión: 1 ho | ra/nivel | ts: no |  |
...
| duraCión: permanente | ts: no | r |
| Este conjuro convierte el<br>cipiente similar en agua b<br>pudiendo convertir el agua<br>boca mágica (ilusionis<br>tl: 1 AlCA | agua pre<br>endita. E<br>de un re<br>ta nive<br>nCe: toqu | sente en un<br>l conjuro e<br>cipiente en<br>l 2, mago n<br>e CoMpon |
| duraCión: permanente | ts: no | r |
| Este conjuro confiere a un o<br>tivará siempre que se cumpl<br>por el lanzador (condicione<br>imagen o el sonido). La boc<br>de 25 palabras, en una de la<br>bola de fuego (mago<br>tl: 1 AlCAnC | bjeto un<br>an unas<br>s que d<br>a emitir<br>s lenguas<br>nivel<br>e: 150 me | a boca mági<br>condiciones<br>eben estar b<br>á un mensaj<br>conocidas<br>3)<br>tros CoMpon |
| duraCión: instantáneo ts: | DES mitad | r |
...
| El lanzador,<br>de escritura<br>conjuro de<br>runas, etc. L<br>En lo tocan<br>sa, como las<br>las mismas<br>Un fallo ind<br>pernicioso s<br>bruma (il<br>tl: 1 | gracias a es<br>normal y<br>marca arcan<br>a escritura<br>te a la escri<br>runas expl<br>y realizar u<br>ica que el<br>e activa.<br>usionista n<br>AlC | te conjuro, p<br>mágica inclu<br>a, ya sea en<br>no mágica s<br>tura mágica<br>osivas, el con<br>na tirada de<br>borrado tien<br>ivel 2, mago<br>AnCe: 40 metros | uede bo<br>yendo<br>un libr<br>erá bor<br>de natu<br>jurado<br>caracter<br>e éxito<br>nivel 2<br>CoM | rrar todo tipo<br>la propia del<br>o, pergamino,<br>rada siempre.<br>raleza peligro-<br>r deberá tocar<br>ística de INT.<br>pero el efecto<br>)<br>ponentes: V y S |
| duraCión: 10 m | in/nivel | ts: no |  | rC: no |
| El lanzador<br>un área de<br>cultando así<br>oscuridad e<br>disipar la br<br>buenas ba<br>tl: 1 | es capaz de c<br>unos 15x6<br>la visión e<br>infravisión)<br>uma.<br>yas (druid<br>Al | rear una bru<br>x6 metros ap<br>n la zona (in<br>. Un viento m<br>a nivel 1)<br>CAnCe: ver texto | ma mági<br>roxima<br>cluyend<br>oderad<br>CoM | ca para cubrir<br>damente, difi-<br>o visión en la<br>o bastará para<br>ponentes: V y S |
| duraCión: 1 d | ía/nivel | ts: no |  | rC: no |
...
| Este conjuro<br>armas y arm<br>afecta a una<br>cada 2 nivele<br>hechizo, siete<br>te un arma o<br>daño durante<br>en los dos últ<br>Calmar a<br>tl: 1 | calienta o en<br>aduras dentr<br>pieza de equ<br>s del lanzad<br>asaltos, cua<br>armadura r<br>los 5 prime<br>imos asaltos<br>nimales (<br>AlCA | fría (pues el conjuro es<br>o del área de efecto. E<br>ipo metálico de una cr<br>or. Durante el tiempo q<br>lquier criatura afectada<br>ecalentada sufrirá 1d4<br>ros asaltos, y 2d4 punto<br>.<br>druida nivel 1)<br>nCe: 15 metros CoMpone |
| duraCión: 1 mi | n/nivel ts | : CAR niega rC |
| Este sortilegio<br>x 10 metros si<br>lanzador podr<br>más de 2d4 da<br>animales se ven<br>Cambiar d<br>tl: 1 | apaciguará a<br>no superan<br>á afectar a una<br>dos de golpe<br>afectados en<br>e forma<br>AlC | todos los animales en un<br>una tirada de salvación d<br>cantidad de animales que<br>+1 DG por nivel del lan<br>orden ascendente de dado<br>(druida nivel 9, mago<br>AnCe: ver texto CoMpone |
| duraCión: 10 m | in/nivel | ts: no rC |
...
| duraCión: 10 m | in/nivel | ts: no | rC: | no |
| La criatura t<br>aguas o por el<br>del lanzamien<br>cosa. Si la elec<br>sobre cualqui<br>incluso lava.<br>por el aire y<br>movimiento y<br>Capa pro<br>tl: 5 | ocada por<br>aire, a ele<br>to. Solo<br>ción es so<br>er líquido<br>Si la elecci<br>ascender<br>con una<br>tector<br>A | el lanzador pod<br>cción del conjura<br>el individuo toca<br>bre el agua, la cria<br>, típicamente agu<br>ón es aire, la cria<br>o descender a mi<br>pendiente máxim<br>a de silas (il<br>lCAnCe: personal | rá camin<br>dor en el<br>do podrá<br>tura podr<br>a, barro<br>tura podr<br>tad de su<br>a de 45 gr<br>usionista<br>CoMponen | ar por las<br>momento<br>hacer tal<br>á caminar<br>o lodo, o<br>á caminar<br>rango de<br>ados.<br>nivel 6)<br>tes: V y S |
| duraCión: 5 a | saltos | ts: INT niega | rC | : sí |
...
| duraCión: 1 min/nivel | ts: no |  |
| Este hechizo permite<br>metros de diámetro a<br>criaturas vivientes, exc<br>criaturas de otros plan<br>invisible, y se mueve c<br>Cerrar portal (<br>tl: 1 A | al lanzador g<br>su alrededor q<br>epto elementa<br>os. El escudo e<br>on el lanzador<br>mago nivel 1)<br>lCAnCe: 15 metr | enerar un<br>ue repele<br>les, muert<br>s transpar<br>.<br>os CoMpo |
| duraCión: ver texto | ts: no |  |
| Este conjuro bloqueará<br>si poseyera una cerradur<br>apertura o disipar magia<br>Círculo de telep<br>tl: 10 min | mágicamente un<br>a u otro tipo d<br>cancelará los e<br>ortación<br>AlCAnCe: ver text | a puerta, o<br>e cerrojo. U<br>fectos de ce<br>(mago niv<br>o CoMpo |
| duraCión: 1 turno/nivel | ts: no |  |
| Mediante este hechizo<br>de unos tres metros de<br>que teleportará a cualq<br>ubicación previamente<br>no será posible cambia<br>te indistinguible de la<br>Círculo sanador<br>tl: 1 | , el conjurador<br>diámetro sob<br>uiera que pen<br>designada. Un<br>rla. El círculo<br>superficie sobr<br>(clérigo nive<br>AlCAnCe: ver text | podrá cre<br>re una sup<br>etre en el<br>a vez elegi<br>mágico es<br>e la que d<br>l 4)<br>o CoMpo |
| duraCión: permanente | ts: no |  |
| En un radio de 6 metr<br>tro del área será sanad<br>si son aliados o enem<br>penetre en esta área re<br>Clarividencia (m<br>tl: 1 | os desde el lan<br>o 2d8 puntos<br>igos. Cualquie<br>cibirá 2d8 pun<br>ago nivel 3)<br>AlCAnCe: ver text | zador, tod<br>de golpe,<br>r muerto<br>tos de dañ<br>o CoMpo |
| duraCión: 1 min/nivel | ts: no |  |
...
| Este hechizo per<br>plano etéreo. El<br>60 días y puede c<br>material por nive<br>maño real del cof<br>voluntad esté don<br>Si se supera el lím<br>rarse rápidamente<br>que se pierda par<br>del cofre debe co<br>este conjuro solo<br>vez. A discreción<br>juros poderosos d<br>descubrir un cofr<br>Comandar pl<br>tl: 1 | mite al lanzador<br>cofre permanecer<br>ontener hasta 3<br>l de lanzador, in<br>re. El lanzador p<br>de esté hasta el ve<br>ite de tiempo, el<br>. Hay un 5% de<br>a siempre. Cualq<br>mer y envejecerá<br>es posible mante<br>del Narrador, el<br>e búsqueda pod<br>e secreto.<br>antas (druida<br>AlCAnCe: 50 me | ocultar un<br>á oculto un<br>0 centímetros<br>dependientem<br>uede recuper<br>ncimiento de<br>cofre comien<br>probabilidad<br>uier criatura<br>normalment<br>ner un cofre<br>uso de determ<br>rían permitir<br>nivel 8)<br>tros CoMpon | cofre en el<br>máximo de<br>cúbicos de<br>ente del ta-<br>ar el cofre a<br>los 60 días.<br>za a deterio-<br>por día de<br>viva dentro<br>e. Mediante<br>secreto a la<br>inados con-<br>le a alguien<br>entes: V y S |
| duraCión: ver text | o ts: no | r | C: sí |
...
| A través de<br>lanzador o<br>cundante. E<br>siguientes t<br>minerales,<br>población a<br>bosque y si<br>turales. El<br>nivel al aire<br>funciona en<br>zada totalm<br>Confusió<br>tl: 1 | la com<br>btiene co<br>l lanza<br>emas: la<br>los cuer<br>nimal e<br>hay pr<br>hechizo<br>libre y d<br>lugares<br>ente por<br>n (ilusi | unión mágica c<br>nocimiento del<br>dor aprende hast<br>región y su orog<br>pos de agua, po<br>n general, pobla<br>esencia de poder<br>tiene un alcance<br>e 30 metros bajo<br>donde la natura<br>la civilización.<br>onista nivel 4,<br>AlCAnCe: 40 metros | on la na<br>área o te<br>a tres hec<br>rafía, las<br>blaciones<br>ción de c<br>osas criat<br>de 2 kiló<br>tierra. El<br>leza ha si<br>mago nive<br>CoMpon |
| duraCión: 1 as | alto/nivel | ts: SAB niega | r |
| Este conjur<br>criaturas en<br>tirada de sa<br>portan de fo<br>tabla d<br>tirada (1d | o provoc<br>un área<br>lvación<br>rma ale<br>e efec<br>10) | a un estado de c<br>de 15 x 15 metro<br>de SAB. Las criatu<br>atoria según la tab<br>tos de la co<br>efecto en l | onfusión<br>s que no s<br>ras afecta<br>la que sig<br>nfusió<br>a criatur |
| 1 | Va | ga errática durante 1<br>imp | minuto (sal<br>ida) |
| 2-3 | In | tenta hacer cosas mu<br>durante | ndanas, com<br>1 asalto |
| 4-6 | N | o hace absolutamente | nada duran |
| 7-8 | Se d | edica a buscar objetos<br>durante | supuestame<br>1 asalto |
| 9 | Ata | ca a la criatura más p | róxima dura |
| 10<br>Las criatura<br>interesara lo<br>que sea atac<br>el siguiente<br>Cono de<br>tl: 1 | s errática<br>que ac<br>ada respo<br>asalto.<br>frío ( | Actúa de forma nor<br>s abandonarán la<br>ontece. Cualquier<br>nderá atacando a<br>mago nivel 5)<br>AlCAnCe: ver texto | mal durante<br>escena co<br>criatura<br>sus atacan<br>CoMpon |
| duraCión: | 1 asalto | ts: DES mitad | r |
...
| El conjuro consagrar purifica<br>irradiando energía beatífica, p<br>sar muertos vivientes con un<br>toda criatura muerta viviente<br>esta zona consagrada deberá re<br>salvación con un penalizador<br>de daño. Si el área consagrad<br>reliquia sagrada, el efecto se v<br>su poder. No se pueden convo<br>en un lugar consagrado.<br>Este conjuro es reversible, pe<br>determinada para producir l<br>descritos.<br>Consagrar mayor (cléri<br>tl: 1 AlCAnCe: | un área de 15<br>otenciando accio<br>bonificador de<br>que se atreva a<br>alizar sus ataque<br>de -1, incluyend<br>a contara con u<br>erá incrementa<br>car o crear mue<br>rmitiendo prof<br>os efectos con<br>go nivel 4)<br>ver texto CoMp | x 15 metros,<br>nes de expul-<br>+3. Además,<br>penetrar en<br>s y tiradas de<br>o sus tiradas<br>na estatua o<br>do, doblando<br>rtos vivientes<br>anar un área<br>trarios a los<br>onentes: V y S |
| duraCión: 1 año ts: | no rC | : ver texto |
...
| Gracias al conjuro de<br>bajar o subir el nivel de<br>del lanzador en un área<br>masas de agua muy gr<br>muy poderoso podría<br>vigoroso remolino capa<br>Por último, si este conj<br>agua, será capaz de ra<br>ciendo a la mitad su ra<br>Controlar los<br>druida nivel 7, mago n<br>tl: 10 min | controlar aguas el l<br>las mismas medio<br>cuadrada de 1 metr<br>andes y profundas,<br>emplear este conjuro<br>z de hacer zozobrar<br>uro se lanza sobre u<br>lentizarlo considerab<br>ngo de movimiento.<br>elementos (clé<br>ivel 6)<br>AlCAnCe:<br>CoM<br>3 kilómetros |
| duraCión: 10 min/nivel | ts: no |
...
| Por medio del conjuro<br>la asistencia de criatura<br>hechizo convoca anim<br>conjurador de nivel 6 p<br>de golpe, o uno de 4 D<br>animales de 1 DG, etc.<br>tre el lanzador limita q<br>El conjurador podrá c<br>pedir que peleen o real<br>aparecerán en el punto<br>ro y actuarán en el mo<br>Convocar anim<br>tl: 1 | de convoca<br>s de la natur<br>ales según e<br>odrá convo<br>G y otro de<br>Aunque el e<br>ue animale<br>omunicarse<br>icen otras t<br>designado d<br>mento de in<br>al o pla<br>AlCAnCe: 15 | r ani<br>aleza<br>l niv<br>car a<br>2 DG<br>ntor<br>s resp<br>a u<br>areas<br>entr<br>iciati<br>nt<br>metros | males podre<br>presentes en<br>el del lanza<br>un animal<br>, o a media<br>no en el que<br>onderán a l<br>n nivel mu<br>sencillas. Lo<br>o del alcance<br>va del lanza<br>a (druida n<br>CoMpone |
| duraCión: 1 asalto/nivel | ts: no |  | rC |
...
| El lanzador pued<br>de su elección (ag<br>elemental de 12 D<br>mental convocad<br>cada dado de gol<br>lanzador mientras<br>si alguien ajeno g<br>puede dar por ter<br>Convocar m<br>tl: 1 | e abrir u<br>ua, tierr<br>G para<br>o tendrá<br>pe. La cri<br>dure el c<br>ana el c<br>minado e<br>onstr<br>AlCA | n portal con el plano<br>a, fuego o aire), invoc<br>que se ponga a sus órd<br>al menos 4 puntos de<br>atura se pondrá a las<br>onjuro, y nunca le atac<br>ontrol del elemental.<br>l conjuro en cualquier<br>uos i (mago nivel 3)<br>nCe: 15 metros CoMpon | elemental<br>ando a un<br>enes. El ele-<br>golpe por<br>órdenes del<br>ará, incluso<br>El lanzador<br>momento.<br>entes: V y S |
| duraCión: 1 asalto/niv | el | ts: no r | C: no |
| En el asalto siguie<br>dentro del área u<br>momento de inic<br>de golpe de los m<br>lanzador, sin que<br>Es decir, si un co<br>ejemplo, podrá co<br>cada una, y una úl<br>el monstruo conv<br>monstruo, con arr<br>Los monstruos at<br>que sean abatidos<br>municarse verbal<br>o dirigir en cierta<br>se ven afectados p<br>muerte, si mueren<br>de los monstruos<br>correspondiente d<br>Convocar m<br>tl: 1 | nte al lan<br>no o vari<br>iativa de<br>onstruos<br>ninguno<br>njurador<br>nvocar a<br>tima de<br>ocado. Se<br>eglo a la<br>acarán a<br>o cese el<br>mente co<br>medida<br>or las ti<br>en com<br>son las<br>el bestia<br>onstr<br>AlCA | zamiento de este conju<br>os monstruos que act<br>l lanzador. La suma d<br>convocados será igual<br>de ellos pueda excede<br>de nivel 8 lanza este h<br>1 criatura de 3 DG, d<br>1 DG. El lanzador no p<br>rá el Narrador quien d<br>s circunstancias de jueg<br>los enemigos del lanz<br>conjuro. Si el lanzado<br>n los monstruos, pued<br>sus acciones. Los mo<br>radas de moral y luch<br>bate desaparecen. Las<br>que se indican en s<br>rio.<br>uos ii (mago nivel 5<br>nCe: 40 metros CoMpon | ro aparecen<br>uarán en el<br>e los dados<br>al nivel del<br>r los 3 DG.<br>echizo, por<br>os de 2 DG<br>odrá elegir<br>etermine el<br>o.<br>ador hasta<br>r puede co-<br>e retenerlos<br>nstruos no<br>an hasta la<br>estadísticas<br>u apartado<br>)<br>entes: V y S |
| duraCión: 1 asalto/niv | el | ts: no r | C: no |
...
| duraCión: ver texto | ts | : no |
| Este conjuro crea<br>tal, piedra, cristal<br>no puede exceder<br>lanzador. Si el ob<br>mado por diversa<br>en una tirada de I<br>del conjuro depen<br>dureza y rareza: la<br>nivel; piedra, crist<br>metales preciosos<br>pecialmente valios<br>Creación men<br>tl: 1 | un element<br>o metal. E<br>los 30 cen<br>jeto tiene<br>s piezas, e<br>NT para c<br>de de los<br>materia ve<br>al y metales<br>a los 20 m<br>os y limita<br>or (ilusion<br>AlCAnCe | o no mágico d<br>l volumen del<br>tímetros cúbico<br>cierta compleji<br>l lanzador deb<br>rearlo con éxit<br>materiales usad<br>getal desaparece<br>básicos tras 1<br>inutos/nivel; ot<br>dos tras 2 asalto<br>ista nivel 4)<br>: 3 metros CoM |
| duraCión: 1 hora/nive | l ts | : no |
| Este conjuro gener<br>getal muerta (mad<br>creado no puede<br>nivel de lanzador.<br>formado por diver<br>en una tirada de I<br>Crear agua (c<br>tl: 1 | a un eleme<br>era, cáñam<br>exceder lo<br>Si el objeto<br>sas piezas,<br>NT para cr<br>lérigo niv<br>AlCAnCe: | nto no mágico<br>o, etc.). El volu<br>s 30 centímetro<br>tiene cierta com<br>el lanzador deb<br>earlo con éxito.<br>el 0, druida ni<br>15 metros CoM |
| duraCión: permanent | e ts | : no |
| Gracias a este conjur<br>terior de un recipien<br>el conjurador podrá<br>Crear comida<br>tl: 10 min | o el lanzado<br>te o en un á<br>generar has<br>y agua<br>AlCAnCe: | r podrá crear ag<br>rea determinada.<br>ta 10 litros de ag<br>(clérigo nivel<br>15 metros CoM |
| duraCión: permanent | e ts | : no |
| Este conjuro hace<br>cada uso de este<br>todo un día a tres<br>grande, más una cr<br>(una grande por c<br>horas, la comida c<br>Crear muerto<br>tl: 1 hora | aparecer d<br>hechizo, s<br>criaturas<br>iatura adic<br>ada tres ni<br>omienza a<br>vivien<br>AlCAnCe: | e la nada comid<br>e consigue ma<br>de tamaño hu<br>ional por nivel<br>veles). Cuando<br>pudrirse, no así<br>te (clérigo ni<br>15 metros CoM |
| duraCión: permanent | e ts | : no |
...
| Hasta ocho animal<br>área de 8 x 8 metros<br>su tamaño, dobland<br>aumento en DG im<br>cación de ataque (B<br>vación y en daño (q<br>conjuro no incluye<br>Crecimiento v<br>vegetal (druida<br>tl: 3 | es seleccionados por<br>crecerán mágicament<br>o igualmente sus da<br>plica también un aum<br>A), en el bonificador<br>ue aumenta un tercio)<br>el control sobre los a<br>egetal/decreci<br>nivel 3)<br>AlCAnCe: 150 metros | el lanzador en un<br>e hasta casi doblar<br>dos de golpe. Este<br>ento en la bonifi-<br>para tiradas de sal-<br>. Sin embargo, este<br>nimales alterados.<br>miento<br>CoMponentes: V y S |
| duraCión: permanente | ts: no | rC: no |
| Gracias a este sort<br>mágicamente toda<br>determinada. Todas<br>entrelazarán de tal<br>rá en una ardua tar<br>de las criaturas afe<br>elección del lanzad<br>metros de radio, o<br>La versión inversa<br>maño de la vegetaci<br>cruzar por el área o<br>Curar enfer<br>(clérigo nivel 3, dr<br>tl: 1 | ilegio, el lanzador p<br>la vegetación compre<br>las plantas en dicha<br>manera que atravesar<br>ea, reduciendo el rang<br>ctadas a la mitad. E<br>or, puede ser o bien<br>un semicírculo de 45<br>de este conjuro per<br>ón hasta que no sea<br>bjetivo.<br>medad/causar<br>uida nivel 3)<br>AlCAnCe: toque | uede hacer crecer<br>ndida en un área<br>zona crecerán y se<br>la misma se torna-<br>o de movimiento<br>l área afectada, a<br>un círculo de 30<br>metros de radio.<br>mite reducir el ta-<br>un problema para<br>enfermedad<br>CoMponentes: V y S |
| duraCión: permanente | ts: ver texto | rC: sí |
...
| duraCión: permanente |  | ts: no | r |
| El lanzador podrá<br>como, por ejemplo<br>mágicas con eleme<br>dera que se puede<br>cúbico.<br>descarga eléc<br>tl: 1 | defor<br>, viga<br>ntos d<br>afecta<br>tric<br>Al | mar objetos<br>s o tablon<br>e madera.<br>r con este<br>a (mago n<br>CAnCe: toque | fabricados<br>es, exceptua<br>El área máx<br>hechizo es<br>ivel 1)<br>CoMpon |
| duraCión: ver texto |  | ts: no | r |
| El lanzador es cap<br>eléctrica al contact<br>de 1d8+1 por nivel<br>de nivel 3 causará<br>que trate activame<br>electrificada forzar<br>ataque de toque. E<br>la descarga con éx<br>través de objetos m<br>deseo (mago niv<br>tl: 1 | az de<br>o con<br>del la<br>1d8+<br>nte de<br>á al l<br>l conj<br>ito. L<br>etálic<br>el 9)<br>AlC | transmitir<br>su mano.<br>nzador. Po<br>3 puntos<br>evitar ser<br>anzador a<br>uro termin<br>a descarga<br>os.<br>AnCe: ver text | una poten<br>El daño pr<br>r ejemplo, u<br>de daño. U<br>tocado po<br>realizar un<br>a una vez s<br>se puede t<br>o CoMpon |
| duraCión: ver texto |  | ts: no | r |
...
| Al usar este hechizo, un<br>rá del dedo índice del la<br>elegida con una explosió<br>criatura golpeada, indepe<br>rayo desintegrador puede<br>estructuras, aunque en est<br>de 3 x 3 x 3 metros de l<br>éxito en su tirada de salva<br>parcialmente, sufriendo 5<br>despistar (ilusionist<br>tl: 1 AlC | brillant<br>nzador<br>n de en<br>ndiente<br>usarse<br>e caso s<br>a mism<br>ción de<br>d6 punt<br>a nivel<br>AnCe: 8 m | e haz de luz<br>para golpear<br>ergía que desi<br>mente de su t<br>también cont<br>olo afectará a<br>a. Las criatur<br>CAR esquiva<br>os de daño.<br>6)<br>etros CoMp | verde surgi-<br>a la víctima<br>ntegrará a la<br>amaño. Este<br>ra objetos y<br>una porción<br>as que tenga<br>n el conjuro<br>onentes: S |
| duraCión: 1 asalto/nivel t | s: INT nie | ga | rC: no |
| Mediante este conjuro, el<br>ilusorio mientras su yo v<br>un hechizo de invisibilid<br>cance del hechizo, pero a<br>los deseos del lanzador, q<br>su copia. El doble se mue<br>del lanzador, puede habla<br>siente real. El doble no pu<br>puede fingir que lo hace.<br>copia aparezca superpues<br>los posibles observadores<br>desplazamiento (i<br>tl: 1 AlC | lanzad<br>erdader<br>ad. El d<br>partir d<br>ue puede<br>ve segú<br>r y gesti<br>ede atac<br>El conj<br>ta sobre<br>se den c<br>lusionis<br>AnCe: ver | or hace aparec<br>o desaparece<br>oble aparece d<br>e entonces se<br>separarse cua<br>n el rango de<br>cular, e inclu<br>ar ni lanzar h<br>urador puede<br>su posición, e<br>uenta de que<br>ta nivel 3, m<br>texto CoMpo | er un doble<br>afectado por<br>entro del al-<br>mueve según<br>nto desee de<br>movimiento<br>so huele y se<br>echizos, pero<br>hacer que su<br>vitando que<br>se desvanece.<br>ago nivel 3)<br>nentes: V y S |
| duraCión: 1 asalto/nivel | ts: no |  | rC: no |
...
| Gracias a este sort<br>alineamiento de in<br>artefactos. Los obje<br>aura solo discernibl<br>(LB, LN, LM, etc.).<br>malvada, el veneno<br>como tales, así que<br>do. El conjurador d<br>una dirección elegi<br>detectar esc<br>tl: 1 | ilegio, el conju<br>dividuos, mons<br>tos o individuo<br>e para el lanzad<br>En el caso par<br>o las trampas<br>no pueden ser<br>eberá concentr<br>da para obtener<br>udriñamien<br>AlCAnCe: ver t | rador<br>truos e<br>s brillar<br>or según<br>ticular d<br>no son<br>detectad<br>arse dur<br>la info<br>to (ma<br>exto | podrá detectar el<br>incluso objetos y<br>án con una tenue<br>su alineamiento<br>e la componente<br>objetos malvados<br>os por este méto-<br>ante un asalto en<br>rmación.<br>go nivel 4)<br>CoMponentes: V |
| duraCión: 1 día | ts: no |  | rC: no |
| Una vez lanzado e<br>de cualquier intent<br>sea por un conjuro<br>intento de observac<br>tra a no más de 50<br>idea clara de su pos<br>detectar ilus<br>tl: 1 | l conjuro, el co<br>o de observarle<br>u objeto mági<br>ión, si la fuent<br>metros del lan<br>ición.<br>iones (ilusio<br>AlCAnCe: toq | njurado<br>a travé<br>co. Una<br>e de la<br>zador, e<br>nista ni<br>ue C | r será consciente<br>s de la magia, ya<br>vez detectado el<br>misma se encuen-<br>ste obtendrá una<br>vel 0)<br>oMponentes: V, S |
| duraCión: 1 min/nivel | ts: no |  | rC: no |
| Con este hechizo, la<br>mediata de las ilusio<br>mirando, dentro de<br>de ancho. La criatur<br>durante un asalto co<br>detectar lo<br>nivel 2)<br>tl: 1 | criatura objetivo<br>nes existentes en<br>un área de 15 m<br>a debe concentr<br>mpleto para obt<br>invisible (il<br>AlCAnCe: 30 m | se perca<br>la direc<br>etros de l<br>arse en l<br>ener la i<br>usionist<br>etros C | tará de manera in-<br>ción en la que esté<br>argo por 3 metros<br>a dirección elegida<br>nformación.<br>a nivel 1, mago<br>oMponentes: V y S |
| duraCión: 10 min/nivel | ts: no |  | rC: no |
| Gracias a este efecto<br>brir aquellos objeto<br>bles dentro del alca<br>detectar ma<br>2, mago nivel 0)<br>tl: 1 | arcano, el lanz<br>s o individuos<br>nce del conjuro<br>gia (clérigo n<br>AlCAnCe:<br>radio de 15 me | ador ser<br>que se<br>.<br>ivel 0, i<br>tros | á capaz de descu-<br>mantienen invisi-<br>lusionista nivel<br>CoMponentes: V |
| duraCión: 1 min/nivel | ts: no |  | rC: no |
...
| duraCión: 1 min/ | nivel ts: | no |
| Por medio de es<br>la presencia de<br>terminada. El c<br>durante al men<br>para obtener la<br>detectar<br>tl: 1 | te hechizo, el<br>criaturas mue<br>onjurador deb<br>os un asalto<br>información.<br>neutralida<br>AlCAnCe: | lanzador es capa<br>rtas vivientes en<br>erá mantenerse<br>en la dirección<br>d (druida nivel<br>50 metros CoMpo |
| duraCión: 10 min/ | nivel ts: | no |
| Gracias a este s<br>neamiento neu<br>3 metros de an<br>brillarán con u<br>zador según su<br>malvado, caóti<br>concentrarse du<br>obtener la infor<br>detectar<br>tl: 1 | ortilegio, el la<br>tral en un pas<br>cho frente a<br>na tenue aura<br>alineamiento<br>co neutral, etc<br>rante un asalt<br>mación.<br>puertas se<br>AlCAnCe: | nzador podrá de<br>illo de 50 metro<br>él. Los objetos o<br>solo discernible<br>: neutral autént<br>étera. El conjur<br>o en la dirección<br>cretas (clérigo<br>30 metros CoMpo |
| duraCión: 1 min/ | nivel ts: | no |
| Gracias a este p<br>tas secretas en<br>trarse durante u<br>información.<br>detectar<br>tl: 1 | oder, el lanzad<br>el área elegida<br>n asalto en u<br>trampas (cl<br>AlCAnCe: | or es capaz de lo<br>. El lanzador de<br>na dirección par<br>érigo nivel 2)<br>15 metros CoMpo |
| duraCión: 10 min/ | nivel ts: | no |
...
| Una vez lanzado e<br>objeto o ser vivo<br>ello el objeto ha d<br>juro. El conjurado<br>del veneno, adem<br>del lanzador de q<br>detener el t<br>tl: 1 | l conjuro, el<br>es venenoso<br>e encontrarse<br>r detectará au<br>ás hay un 5%<br>ue detecte el ti<br>iempo (ma<br>AlCAnCe: v | mago pue<br>o ha sido<br>dentro d<br>tomática<br>de proba<br>po de ve<br>go nivel<br>er texto | de detectar si algún<br>envenenado. Para<br>el alcance del con-<br>mente la existencia<br>bilidades por nivel<br>neno.<br>9)<br>CoMponentes: V y S |
| duraCión: 1d4+1 | ts: n | o | rC: sí |
| Este potente hech<br>temporal, detenie<br>para el lanzador,<br>asaltos que dure e<br>discernir dir<br>tl: 1 | izo es capaz<br>ndo su avance<br>que podrá ac<br>l conjuro.<br>ección (dru<br>AlCAnCe: p | de alterar<br>moment<br>tuar libre<br>ida nivel<br>ersonal | el normal devenir<br>áneamente excepto<br>mente durante los<br>0)<br>CoMponentes: V y S |
| duraCión: ver text | o ts: n | o | rC: no |
| Gracias a este so<br>dirección se encu<br>durante un día c<br>blecer algún tipo<br>circundante.<br>discernir u<br>(clérigo nive<br>tl: 10 min | rtilegio, el dr<br>entra el norte.<br>omo mínim<br>de señal o r<br>bicación/<br>l 8)<br>AlCAnCe: v | uida siem<br>Retendr<br>o, más si<br>ecordator<br>oculta<br>er texto | pre sabrá en qué<br>á esta información<br>es capaz de esta-<br>io en la orografía<br>r ubicación<br>CoMponentes: V y S |
| duraCión: instantáne | o ts: n | o | rC: no |
...
| Una vez lanzado e<br>y objetos mágicos<br>del lanzador y las<br>automáticamente.<br>momento termina<br>piedades (que se re<br>cuanto termina el<br>efectos de este con<br>sos, aunque a disc<br>superar una tirada<br>epígrafe sobre tirad<br>disipar el ma<br>tl: 1 | ste conju<br>en un r<br>criaturas<br>Es decir,<br>y los ob<br>cuperan<br>hechizo<br>juro los<br>reción d<br>de salvac<br>as de sal<br>l/bien<br>AlCAn | ro, todos los sortile<br>adio de 20 metros,<br>elegidas por él, so<br>cualquier hechizo a<br>jetos mágicos pierd<br>si salen del rango d<br>). Únicamente se li<br>artefactos mágicos<br>el Narrador, podría<br>ión, tal y como se d<br>vación de objetos de<br>(clérigo nivel 5)<br>Ce: ver texto CoMpon |
| duraCión: 1 asalto/nivel | t | s: no r |
| El lanzador obtien<br>ataques del alineam<br>cualquier conjuro<br>ción de aquellos q<br>conjuro de disipar<br>podrá forzar a cri<br>tadas, y del alineam<br>con solo tocarlas.<br>de salvación, pero<br>abruptamente con<br>disipar ilusio<br>tl: 1 | e un bo<br>iento el<br>que lan<br>ue no p<br>magia.<br>aturas co<br>iento el<br>La criat<br>un sol<br>el hechi<br>nes (ilu<br>AlCAnC | nificador de +4 a su<br>egido. Asimismo, p<br>cen con solo tocar<br>uedan ser neutraliza<br>Adicionalmente, el<br>nvocadas, conjurad<br>egido, a que vuelvan<br>ura no tendrá derec<br>o uso de esta facul<br>zo.<br>sionista nivel 3)<br>e: 50 metros CoMpon |
| duraCión: ver texto | t | s: no r |
| Este conjuro disipa<br>10 x 10 x 10 metr<br>tirada de INT con<br>para eliminarla, sa<br>mismo. Puede que<br>tes para este conjur<br>disipar magi<br>ilusionista nivel 3<br>tl: 1 | todas la<br>os. El la<br>tra cada<br>lvo que<br>algunas i<br>o (si así<br>a (cléri<br>, mago<br>AlCAnC | s ilusiones dentro d<br>nzador debe tener é<br>una de las ilusion<br>la ilusión la hubiera<br>lusiones sean demas<br>se indica en sus desc<br>go nivel 3, druid<br>nivel 3)<br>e: 40 metros CoMpon |
| duraCión: ver texto | t | s: no r |
...
| El lanzador toca una<br>mostrará el doble de<br>imagen debe superar<br>darse cuenta del enga<br>dormir (mago niv<br>tl: 1 | pila de tesoro<br>riquezas. Cualq<br>una tirada de<br>ño.<br>el 1)<br>AlCAnCe:<br>área de 20 metro | y crea un<br>uier criat<br>salvación<br>CoMp<br>s | a ilusión que<br>ura que vea la<br>de INT para<br>onentes: V y S |
| duraCión: 1 turno/nivel | ts: no |  | rC: sí |
| Este conjuro provoca<br>alcance caigan en un<br>solo afectará a criatu<br>yores que un hombre<br>de 2d4 DG de criatu<br>DG serán las primer<br>1 DG serán consider<br>como de 1 dado de g<br>quedarán indefensas.<br>mortal despertará al s<br>otras criaturas específ<br>dotar de cons<br>tl: 1 día | rá que todas la<br>sopor parecid<br>ras pequeñas,<br>con 4 DG o<br>ras afectadas. L<br>as afectadas, y<br>adas, para los<br>olpe. Las criat<br>No obstante,<br>ujeto afectado.<br>icas son inmu<br>ciencia (dru<br>AlCAnCe: toque | s criaturas<br>o al sueñ<br>o human<br>menos, co<br>as criatur<br>aquellas c<br>efectos de<br>uras caerá<br>una herid<br>Los muer<br>nes a estos<br>ida nivel<br>CoMp | dentro de su<br>o. El conjuro<br>oides no ma-<br>n un máximo<br>as con menos<br>on menos de<br>este conjuro,<br>n dormidas y<br>a o golpe no<br>tos vivientes y<br>efectos.<br>5)<br>onentes: V y S |
| duraCión: permanente | ts: SAB niega |  | rC: sí |
...
| duraCión: 10 min/nivel | ts: no |  |
| Este conjuro permi<br>mino más corto y<br>tanto si es al aire lib<br>sabrá qué dirección<br>El conjuro termina<br>el conjuro solo fun<br>sirve, por ejemplo,<br>que se esconde un li<br>la localización de u<br>ha de estar en el mi<br>Este conjuro es rev<br>criatura perdida no<br>el lanzador, aunque<br>encontrar fa<br>tl: 1 día | te que la criatura<br>directo para entra<br>re como bajo tierr<br>debe tomar para h<br>cuando se llega al<br>ciona con localiz<br>para hallar el cami<br>che que se ha de d<br>n artefacto. Por últ<br>smo plano que el<br>ersible (perder el c<br>logre encontrar u<br>lo conociera ante<br>miliar (mago ni<br>AlCAnCe: ver texto | tocada co<br>r o salir<br>a. La cria<br>allar el lu<br>destino. S<br>aciones c<br>no hacia<br>estruir o<br>imo, el lu<br>lanzador.<br>amino) y<br>n lugar d<br>riorment<br>vel 1)<br>CoMpo |
| duraCión: ver texto | ts: no |  |
...
| 13-15 |  | Sapo |  |  |
| 16-18 |  | Comadreja |  |  |
| 19 | A elección d<br>criaturas anter<br>rata | el jugador, que pue<br>iores u otra parecid<br>, una serpiente, un | de elegir u<br>a (un murc<br>lince, etc.) | na de las<br>iélago, una |

20 Una criatura especial, probablemente de naturaleza mágica, como, por ejemplo, un pequeño demonio sirviente. Las características y habilidades exactas las establece el Narrador
...
| El lanzador cubre un á<br>un velo mágico, proteg<br>de observación tanto m<br>to del lanzamiento, el<br>que será la percibida<br>La observación mágica<br>En el caso de la obser<br>Narrador lo considera<br>detectase la ilusión med<br>engaño (ilusionista<br>tl: 1 A | rea de 8 met<br>iendo el int<br>undana co<br>conjurador<br>por cualqu<br>no puede<br>vación dire<br>oportuno,<br>iante una t<br>nivel 2)<br>lCAnCe: 15 m | ros cúbico<br>erior de cu<br>mo mágica.<br>debe defin<br>ier intento<br>darse cuen<br>cta real de<br>se podría<br>irada de sal<br>etros C |
| duraCión: 1 asalto/nivel | ts: SAB nie | ga |
...
| 4 |  |  | Ciempiés |  |
| 5 |  |  | Langostas |  |
| 6<br>Una criatura atra<br>táneamente el sen<br>to de daño al fi<br>combatir al enja<br>un punto adicio<br>cabo cualquier o<br>da). Las armas co<br>el fuego y los ata<br>se mantendrá act<br>lanzador manten<br>a cabo ninguna o<br>puntos de daño p<br>enjambre ele<br>tl: 10 min | pad<br>tido<br>nal<br>mbr<br>nal p<br>tra a<br>mu<br>ques<br>ivo d<br>ga la<br>tra a<br>or n<br>me | a dentro del<br>de la direcci<br>del asalto si<br>e, recibiendo<br>or nivel del<br>cción (inclu<br>nes no pued<br>de área sí p<br>urante dos a<br>concentraci<br>cción. Si el e<br>ivel del lanz<br>ntal (drui<br>AlCAnCe: 50 | Escarabajos vol<br>enjambre perde<br>ón. Además, su<br>se dedica por<br>1d4 puntos de<br>lanzador si trata<br>ido escapar del<br>en dañar al enja<br>ueden hacerlo.<br>saltos más el tie<br>ón, no pudiend<br>njambre recibe u<br>ador, también se<br>da nivel 9)<br>metros CoMpon | adores<br>rá momen-<br>frirá 1 pun-<br>completo a<br>daño más<br>de llevar a<br>área afecta-<br>mbre, pero<br>El enjambre<br>mpo que el<br>o este llevar<br>n total de 2<br>dispersará.<br>entes: V y S |
| duraCión: 10 min/n | ivel | ts: no | r | C: no |
| El lanzador pued<br>tales de un tipo<br>acudirá en su ay<br>sido convocados<br>después aparecer<br>minutos después<br>tiene al menos 5<br>les obedecerán al<br>criatura toma el<br>enmarañar<br>tl: 1 | e co<br>dete<br>uda.<br>2d4<br>án 1<br>1 ele<br>punt<br>lanz<br>cont<br>(dru | nvocar a un p<br>rminado (fu<br>Una vez re<br>elementales g<br>d4 elemental<br>mental may<br>os de golpe p<br>ador y jamás<br>rol de los mi<br>ida nivel 1)<br>AlCAnCe: 140 | equeño ejército<br>ego, aire, agua,<br>alizado el conju<br>randes (8 DG).<br>es enormes (12<br>or (16 DG). Cad<br>or cada DG. Lo<br>le atacarán, inc<br>smos.<br>metros CoMpon | de elemen-<br>tierra) que<br>ro, habrán<br>10 minutos<br>DG), y 10<br>a elemental<br>s elementa-<br>luso si otra<br>entes: V y S |
| duraCión: 1 min/n | ivel | ts: DES ni | ega r | C: no |
...
| Este conjuro i<br>ilusionista y cu<br>El cuerpo del<br>otorgándoles<br>que finalice el<br>otras proteccio<br>Esto quiere de<br>a su CA, solo<br>escritura<br>tl: 1 min | nvoca la im<br>alquier alia<br>dragón fluy<br>un bonifica<br>hechizo. Est<br>nes por equ<br>cir que un a<br>obtendría u<br>ilusoria<br>Al | agen de un<br>do dentro de u<br>e y rodea a la<br>dor máximo<br>a bonificació<br>ipo, ya sean m<br>venturero con<br>n +1 por las es<br>(ilusionista n<br>CAnCe: toque | dragón q<br>n radio d<br>s criatura<br>de +4 a la<br>n no es ac<br>ágicas o<br>una arma<br>camas de<br>ivel 3)<br>CoMpon |
| duraCión: perm | anente t | s: ver texto | r |
...
| Una vez lanzado este potente<br>torno de llamas azules y verde<br>de la criatura que este designe<br>misma iluminación que una<br>al portador de los ataques bas<br>cálidas al contacto, pero no c<br>Todas las tiradas para resistir d<br>con un bonificador de +2. Si<br>ningún daño y, si se falla, ú<br>daño. Si el portador del conjur<br>supera la tirada, sufrirá el dob<br>Este conjuro es reversible y se<br>lo, que protege contra los ataq<br>un ataque de frío provocará d<br>conjuro.<br>escudo de la fe (clérig<br>tl: 1 AlCAnCe | sortile<br>s alrede<br>. El con<br>antorch<br>ados en<br>ausan n<br>año basa<br>se pasa<br>nicamen<br>o recibe<br>le de da<br>puede l<br>ues de<br>oble de<br>o nivel<br>: toque | gio, apare<br>dor del c<br>torno pro<br>a y, adem<br>frío. Las<br>ingún tip<br>do en frí<br>la tirada,<br>te se sufr<br>daño por<br>ño.<br>anzar esc<br>fuego. Par<br>daño al<br>1)<br>CoMpon |
| duraCión: 1 min/nivel ts: | no | r |
| Escudo de la fe produce una es<br>de energía divina que propor<br>tiradas de salvación.<br>escudriñamiento (clérig<br>mago nivel 4)<br>tl: 10 min AlCAnCe: | fera de p<br>ciona un<br>o nivel<br>ver texto | rotección<br>+2 a la<br>5, druid<br>CoMpon |
| duraCión: 1 asalto/nivel ts: ver | texto | r |
...
| El conjurador y el objetivo<br>diferentes | están en planos |  | -15 |
| --- | --- | --- | --- |
| El conjurador no sabe nada | sobre el objetivo |  | -15 |
| El conjurador solo ha oído h | ablar del objetivo |  | -10 |
| El conjurador solo ha vis | to al objetivo |  | -5 |
| El conjurador está en posesión<br>cabello o trozos de uñas | de un mechón d<br>del objetivo | e | +5 |
| El conjurador está en posesió<br>objeto propiedad del | n de una prenda<br>objetivo | u | +5 |
| El conjurador conoce bie | n a su objetivo |  | +5 |
| Si el resultado de la tirad<br>conjurar los siguientes he<br>el escudriñamiento: leer m<br>lenguaje. También podrá<br>éxito del 5% x nivel del l<br>detectar alineamiento, dete<br>escudriñamiento m<br>nivel 7, mago nivel 7)<br>tl: 1 min AlCA | a es exitoso,<br>chizos adicion<br>agia, lenguas y<br>lanzar con un<br>anzador los si<br>ctar magia y<br>ayor (clérig<br>nCe: ver texto | el l<br>ales<br>lee<br>a p<br>gui<br>men<br>o n<br>Co | anzador podrá<br>mientras dure<br>r y comprender<br>robabilidad de<br>entes conjuros:<br>saje.<br>ivel 7, druida<br>Mponentes: V y S |
| duraCión: 1 min/nivel ts | : ver texto |  | rC: sí |
| Este conjuro es una versi<br>to, ya que su duración es<br>siempre que el intento ten<br>hechizos adicionales: detec<br>leer magia, lenguas, leer y<br>El resto de su funcionamie<br>de escudriñamiento.<br>esfera invulnerabl<br>tl: 1 AlCA | ón mejorada<br>superior y pe<br>ga éxito, conj<br>tar alineamien<br>comprender le<br>nto es igual al<br>e (mago nive<br>nCe: personal | de<br>rm<br>ura<br>to,<br>ng<br>del<br>l 6<br>Co | escudriñamien-<br>ite al lanzador,<br>r los siguientes<br>detectar magia,<br>uaje, y mensaje.<br>conjuro básico<br>)<br>Mponentes: V y S |
| duraCión: 1 asalto/nivel | ts: no |  | rC: no |
| Mediante este conjuro el l<br>esfera mágica que apenas s<br>de luz. La esfera no se mue<br>por lo que si el conjurado<br>Una vez invocada, la esfer<br>afectado por cualquier co<br>los efectos de objetos mági<br>de una criatura. El conjur<br>afecten a blancos y áreas<br>manezca dentro de la mis<br>destruirá la esfera de form<br>esfera invulnerabl<br>tl: 1 AlCA | anzador crea a<br>e distingue com<br>ve del sitio en<br>r se mueve, de<br>a impide que<br>njuro de nivel<br>cos o habilidad<br>ador podrá la<br>fuera de la es<br>ma. Un conjur<br>a inmediata.<br>e menor (m<br>nCe: personal | lre<br>o u<br>el q<br>jará<br>el l<br>1 a<br>es<br>nza<br>fer<br>o d<br>ag<br>Co | dedor suyo una<br>n pequeño haz<br>ue es invocada,<br>atrás la esfera.<br>anzador se vea<br>4, incluyendo<br>mágicas innatas<br>r conjuros que<br>a mientras per-<br>e disipar magia<br>o nivel 4)<br>Mponentes: V y S |
| duraCión: 1 asalto/nivel | ts: no |  | rC: no |
...
| Amarillo | 3.º | Elimina los efectos del veneno, gas y petrificación. Causa 40 puntos de daño | Desintegrar |
...
| Este conjuro repele a<br>a retornar a su plano<br>correspondiente tirad<br>expiación( clérigo<br>tl: 1 hora | una criatu<br>natal sie<br>a de salva<br>nivel 5)<br>AlCAnCe: | ra extr<br>mpre qu<br>ción de<br>toque | aplanar,<br>e la cria<br>CAR.<br>CoMpo |
| duraCión: permanente | ts: n | o | r |
...
| El lanzador o l<br>ra voluntaria, a<br>una nube gase<br>afectada puede<br>por pequeñas g<br>ataques físicos c<br>Formas de<br>tl: 1 | a criatura<br>sí como<br>osa. En es<br>desplazar<br>rietas y oq<br>onvencio<br>animal<br>AlCA | tocada, sie<br>todo su eq<br>ta forma i<br>se lentame<br>uedades, si<br>nales, no a<br>(druida ni<br>nCe: 15 metr | mpre que s<br>uipo, se tra<br>nsustancial,<br>nte volando<br>endo ademá<br>sí a conjuro<br>vel 8)<br>os CoMpon |
| duraCión: 1 hora/ | nivel | ts: no | r |
| El lanzador pu<br>un área de 7 x<br>criaturas así afe<br>expire el conjur<br>Cuando un su<br>conjuro, recupe<br>criaturas transf<br>del animal eleg<br>recuerdos. Todo<br>transformado s<br>garrote (d<br>tl: 1 | ede transf<br>7 metros<br>ctadas co<br>o o el lan<br>jeto se co<br>rará todo<br>ormadas<br>ido, cons<br>el equipo<br>e funde en<br>ruida niv<br>Al | ormar a un<br>en un ani<br>ntinuarán e<br>zador decid<br>nvierta en<br>s sus punt<br>adquirirán<br>ervando a<br>transporta<br>su nueva f<br>g<br>el 1)<br>CAnCe: toque | a criatura p<br>mal de su e<br>n esta form<br>a darlo por<br>animal m<br>os de vida.<br>todas las<br>la par su c<br>do por cad<br>orma, y será<br>CoMpon |
| duraCión:<br>1 min/nivel |  | ts: no | r |
...
| duraCión: 1 min/nivel | ts: no |  | rC: sí |
| Este conjuro infund<br>porales, incrementa<br>hechizo es acumul<br>puntuación máxim<br>Fundirse con l<br>tl: 1 | e al objetivo<br>ndo en +1 su<br>ativo, aunqu<br>a de 20.<br>a piedra<br>AlCAnCe: per | una energía<br>puntuación<br>e sin poder<br>(druida niv<br>sonal CoM | y poder tem-<br>de fuerza. El<br>sobrepasar la<br>el 3)<br>ponentes: V y S |
| duraCión: 10 min/nivel | ts: no |  | rC: no |
| El lanzador, y todas<br>pueden fundirse con<br>milar al conjurador.<br>piedra, será conscien<br>solo podrá escuchar<br>la piedra recibe un d<br>el conjuro se disipar<br>rior recibiendo 5d6<br>truida por completo<br>de salvación de SAB<br>como el de transmu<br>de daño al lanzador<br>geas (clérigo nive<br>tl: 10 min | sus posesion<br>la piedra, q<br>El lanzador,<br>te de todo lo<br>y no ver, pero<br>año extremo<br>á y el conjur<br>puntos de da<br>, el conjurado<br>o morirá. Al<br>tar piedra y<br>en el interior<br>l 6, ilusionis<br>AlCAnCe: 3 m | es y equipo<br>ue deberá ser<br>mientras per<br>que pase alre<br>incluso pod<br>(a discreción<br>ador será exp<br>ño. Si la pied<br>r deberá real<br>gunos conjur<br>carne, causar<br>de la piedra.<br>ta nivel 6,<br>etros CoM | transportados,<br>de tamaño si-<br>manezca en la<br>dedor, aunque<br>rá conjurar. Si<br>del Narrador),<br>ulsado al exte-<br>ra resulta des-<br>izar una tirada<br>os específicos,<br>án 5d6 puntos<br>mago nivel 6)<br>ponentes: V y S |
| duraCión: ver texto | ts: CAR n | iega | rC: sí |
...
| El lanzador<br>una runa pro<br>o un objeto.<br>mueva el obj<br>el conjurado<br>es activado in<br>conjuros pue<br>condiciones f<br>gaseosa (siem<br>Hay muchos<br>crean para de<br>(de nivel 3 m<br>de retener pe<br>globo elá<br>tl: 1 | podrá e<br>tectora<br>Cualqui<br>eto, o c<br>r, sufrir<br>cluso p<br>den bu<br>ísicas d<br>pre a di<br>tipos<br>scargar<br>áximo),<br>rsona o<br>stico | mplear este<br>invisible un<br>er criatura q<br>umpla con l<br>á los efectos<br>or criaturas<br>rlar estos g<br>el intruso, c<br>screción del<br>de glifos c<br>los efectos d<br>como un pr<br>una bola de<br>de Fist<br>AlCAnCe: 20 | conjuro para<br>lugar (área de<br>ue atraviese el<br>a condición en<br>del hechizo.<br>invisibles. Au<br>lifos, al igual<br>omo un vamp<br>Narrador).<br>ustodios; gen<br>e un conjuro<br>oyectil mágico<br>fuego.<br>an (mago niv<br>metros CoMpo |
| duraCión: 1 m | in/nivel | ts: DES n | iega |
| Este conjuro<br>envuelve a la<br>tamaño no re<br>una tirada de<br>salvo que des<br>Esta esfera p<br>mágico que s<br>disipar magia<br>sar daño a q<br>entrar ni sali<br>esfera se pued<br>movimientos<br>Hablar co<br>tl: 1 | genera<br>criatur<br>base el<br>salvaci<br>ee pene<br>rotege c<br>e quier<br>o desin<br>uien se<br>r del gl<br>e move<br>de la cr<br>n las | una esfera d<br>a blanco de<br>de la esfera.<br>ón de DES p<br>trar en la esf<br>ontra cualq<br>a infligir ex<br>tegrar, que<br>encuentre e<br>obo hasta q<br>r si se empuj<br>iatura que se<br>H<br>plantas<br>AlCAnCe: pe | e 3 metros de<br>l conjuro, sie<br>La criatura tie<br>ara evitar que<br>era voluntaria<br>uier tipo de d<br>ceptuando los<br>destruirán la e<br>n su interior.<br>ue no expire e<br>a desde el exte<br>encuentre en<br>(druida nive<br>rsonal CoMpo |
| duraCión: 1 m | in/nivel | ts: no |  |
...
| Mediante es<br>go, de 3 met<br>dentro del a<br>quier criatur<br>daño por ni<br>de salvación<br>guardas y<br>tl: 30 m | te conjuro<br>ros de radi<br>lcance del<br>a que se<br>vel del lanz<br>de DES, s<br>custod<br>in A | se crea un<br>o, en el lug<br>conjuro. E<br>halle dentr<br>ador. Si la<br>olo recibe<br>ias (ilusion<br>lCAnCe: ver | a columna verti<br>ar que designe e<br>sta columna ca<br>o del área 1d6<br>criatura supera<br>la mitad de dañ<br>ista nivel 5, ma<br>texto CoMpone | cal de fue-<br>l lanzador<br>usa a cual-<br>puntos de<br>una tirada<br>o.<br>go nivel 6)<br>ntes: V y S |
| duraCión: 1 h | ora/nivel | ts: ver tex | to rC: v | er texto |
| Este poderos<br>sa de torres,<br>debe estar en<br>el hechizo. El<br>generando un<br>metro. Toda<br>dad. Dentro<br>a continuació<br>los efectos; si<br>1. Ante un<br>verse afectad<br>avanzando e<br>quería toma<br>2. Los pasa<br>niebla que n<br>3. Todas la<br>rradura (inv<br>4. Una pue<br>ilusión que l<br>5. Los tram<br>los efectos d<br>regeneran tra<br>6. El lanza<br>zar dos<br>Hablar c<br>tl: 1 | o hechizo e<br>fortalezas y<br>algún punt<br>conjuro se<br>a esfera de<br>la zona pro<br>de la esfera,<br>n. Un conj<br>tiene éxito<br>a bifurcaci<br>os por un<br>xactament<br>r (RC: sí).<br>jes de la z<br>o permite<br>s puertas e<br>erso de ap<br>rta por niv<br>a hace apar<br>os de escale<br>el conjuro<br>s 10 minut<br>dor puede<br>conjuros d<br>on los | s una herra<br>otras gua<br>o dentro d<br>propaga de<br>5 metros p<br>tegida irra<br>se produce<br>uro de disi<br>, eliminará<br>ón hay un<br>a especie d<br>e en la dire<br>ona proteg<br>ver más al<br>stán bajo<br>ertura, RC:<br>el del lanza<br>ecer como<br>ra quedan<br>del mism<br>os tras hab<br>elegir dos<br>e boca má<br>animales<br>AlCAnCe: per | mienta muy útil<br>ridas parecidas.<br>el área a proteger<br>sde la posición d<br>or nivel del lanza<br>dia magia con g<br>n los efectos que<br>par magia debe el<br>solo ese efecto.<br>50% de probab<br>e confusión par<br>cción contraria<br>ida se llenan de<br>lá de 2 metros (<br>los efectos del c<br>no).<br>dor queda cubie<br>parte de la pared<br>cubiertos por tel<br>o nombre, salvo<br>er sido destruida<br>localizaciones p<br>gica (RC: no).<br>(druida nivel<br>sonal CoMpone | en la defen-<br>El lanzador<br>para lanzar<br>el lanzador<br>dor de diá-<br>ran intensi-<br>se detallan<br>egir uno de<br>ilidades de<br>a terminar<br>a la que se<br>una densa<br>RC: no).<br>onjuro ce-<br>rta por una<br>(RC: no).<br>arañas, con<br>porque se<br>s (RC: no.<br>ara empla-<br>2)<br>ntes: V y S |
| duraCión: 1 m | in/nivel | ts: no | rC | : no |
...
| Este potente co<br>bargo, el total d<br>ta el doble del<br>realizarán sus t<br>de -2. Si hay m<br>ser hechizadas,<br>se ven afectadas<br>Hechizar<br>nivel 4)<br>tl: 1 | njuro fu<br>e DG/n<br>nivel de<br>iradas d<br>ás criatu<br>el lanz<br>, hasta l<br>mons | nciona como<br>iveles que se v<br>l lanzador. To<br>e salvación de<br>ras dentro del<br>ador elige una<br>legar al límite<br>truo (ilus<br>AlCAnCe: 20 me | hechizar perso<br>erán afectados<br>das las criatur<br>CAR con un<br>alcance de las<br>a una el orde<br>de DG/nivele<br>ionista nive<br>tros CoMpon |
| duraCión: 1 día | /nivel | ts: CAR nieg | a r |
| Con este conju<br>su elección. Si<br>durante el tiem<br>un aliado y ami<br>autómata, pero<br>buena predispo<br>corre peligro, e<br>la misma lengu<br>Hechizar<br>tl: 1 | ro el lan<br>la criatu<br>po efect<br>go. El m<br>tomará<br>sición.<br>l hechiz<br>a que la<br>perso | zador podrá h<br>ra falla su tir<br>ivo de conjuro<br>onstruo enca<br>las acciones y<br>Si el monstru<br>o quedará rot<br>criatura para<br>na (ilusionis<br>AlCAnCe: 15 me | echizar a un m<br>ada de salvaci<br>, tomará al lan<br>ntado no actua<br>palabras del la<br>o es amenazad<br>o. El lanzador<br>comunicarse.<br>ta nivel 1, m<br>tros CoMpon |
| duraCión: 1 hora | /nivel | ts: CAR nieg | a r |
...
| El lanzador pr<br>miren fijament<br>y sugerencias e<br>razonables. De<br>criaturas en un<br>las criaturas c<br>ver u oír al la<br>que comprend<br>todas las criatu<br>INT para evita<br>medio del com<br>Las criaturas h<br>tras dure el co<br>ataca o pertur<br>zadas no recor<br>rán que la idea<br>Huella de<br>tl: 1 | ovoca qu<br>e. El conj<br>n las víct<br>esta for<br>área de 8<br>on meno<br>nzador s<br>an lo que<br>ras tiene<br>r los efec<br>bate u ot<br>ipnotizad<br>njuro, au<br>ba de algu<br>darán ha<br>o sugere<br>drag | e las criaturas<br>urador puede<br>imas, aunque<br>ma se pueden<br>x 8 metros. P<br>s DG. Solo l<br>on afectadas,<br>dice el conju<br>n derecho a u<br>tos, y el conju<br>ras situacione<br>as no pueden<br>nque pueden s<br>na otra mane<br>ber estado en<br>ncia implanta<br>ón (ilusionis<br>AlCAnCe: toque | cercanas se det<br>entonces impla<br>estas deben se<br>afectar hasta 2<br>rimero se verán<br>as criaturas qu<br>aunque no es<br>rador. En cualq<br>na tirada de sal<br>ro nunca tendr<br>s peligrosas.<br>moverse ni act<br>er “despertada<br>ra. Las criatura<br>trance, al desp<br>da parte de ella<br>ta nivel 0)<br>CoMponen | engan y le<br>ntar ideas<br>r breves y<br>d4 DG de<br>afectadas<br>e pueden<br>necesario<br>uier caso,<br>vación de<br>á éxito en<br>uar mien-<br>s” si se las<br>s hipnoti-<br>ertar cree-<br>s mismas.<br>tes: V y S |
| duraCión: ver | texto | ts: INT niega | rC | : sí |
...
| El lanzador invoca<br>ño de un puño. Mi<br>rá los tres primeros<br>cada impacto direct<br>el doble de daño, y<br>imagen. El hechizo<br>aleja a más de 3 me<br>en funcionamiento<br>del Narrador) tendr<br>imagen bendi<br>tl: 1 | una imagen<br>entras dure<br>puntos de d<br>o. Sin emba<br>a que afect<br>termina in<br>tros del lanz<br>, ningún otr<br>á efecto sob<br>ta (ilusion<br>AlCAnCe | de sí mism<br>el conjuro,<br>año sufrid<br>rgo, los ata<br>an tanto al<br>mediatame<br>ador. Mien<br>o conjuro d<br>re el conju<br>ista nive<br>: ver texto | o en arcilla<br>dicha figur<br>os por el la<br>ques de áre<br>lanzador<br>nte si la es<br>tras este co<br>el estilo (a<br>rador.<br>l 2)<br>CoMponen |
| duraCión: 1 asalto/nive | l ts: CA | R niega | rC |
| El lanzador hace ap<br>quier punto a la vis<br>tirada de salvación<br>lido a atacar a la im<br>se dará cuenta del e<br>imagen despl<br>tl: 1 | arecer la im<br>ta. Cualquie<br>de CAR se s<br>agen. Sin e<br>ngaño y no<br>azada (i<br>AlCAnCe: | agen de un<br>r muerto v<br>entirá irre<br>mbargo, tr<br>volverá a a<br>lusionista<br>15 metros | ser bendit<br>iviente qu<br>mediablem<br>as realizar<br>tacar a la i<br>nivel 3)<br>CoMponen |
| duraCión: 1 asalto/nive | l ts: IN | T niega | rC |
| El lanzador se fija<br>ser. La ilusión se m<br>enemigos que pue<br>importa si la ilusi<br>el golpe y continu<br>no puede hacer ni<br>imagen mayor<br>tl: 1 | en una cri<br>uestra agre<br>dan verla, t<br>ón sufre da<br>ará combati<br>ngún daño.<br>(ilusionist<br>AlCAnCe: | atura y cr<br>siva y peli<br>ratando de<br>ño, parece<br>endo. Por<br>a nivel 3<br>140 metros | ea una co<br>grosa para<br>atraer at<br>rá que ha<br>sí misma,<br>)<br>CoMponen |
| duraCión: ver texto | ts: IN | T niega | rC: |
...
| Este conjuro es<br>ofrece los mism<br>imagen pro<br>tl: 1 | una versión mejorada<br>os efectos, pero con<br>gramada (ilusi<br>AlCAnCe: 50 m | de imagen ve<br>una duración<br>onista nive<br>etros CoMp | rdadera, ya que<br>permanente.<br>l 6)<br>onentes: V y S |
| duraCión: 1 asalt | o/nivel ts: INT nie | ga | rC: no |
| Este conjuro p<br>dera; sin emb<br>ción para que<br>basada en algo<br>cerá activo mi<br>imagen ref<br>tl: 1 | roduce los mismos<br>argo, el lanzador pu<br>la ilusión se active<br>que se pueda perci<br>entras no se active l<br>lejada (ilusionist<br>AlCAnCe: 15 m | efectos que<br>ede establec<br>(esta condic<br>bir). El con<br>a ilusión.<br>a nivel 2, m<br>etros CoMp | imagen verda-<br>er una condi-<br>ión debe estar<br>juro permane-<br>ago nivel 2)<br>onentes: V y S |
| duraCión: 3 asalto | s/nivel ts: no |  | rC: no |
...
| Este hechizo proye<br>tancia o campo de<br>12 metros cúbicos<br>incluye sonido, ol<br>percibida como re<br>mensaje diseñado<br>la ilusión creerán<br>recho a una tirada<br>de que es una ilus<br>tirada de salvación<br>otro modo, las cri<br>la veracidad de lo<br>de las ilusiones. La<br>el conjurador en e<br>desplazarse dentro<br>es necesario que el<br>implantar em<br>tl: 1 | cta la imagen d<br>energía, que c<br>+ 3 metros cúb<br>or, tacto y todo<br>al. La ilusión<br>por el lanzado<br>que lo que ven<br>de salvación<br>ión. Si al men<br>, la ilusión des<br>aturas afectadas<br>que ven, que p<br>ilusión sigue u<br>l momento del<br>del alcance del<br>lanzador mant<br>oción (ilusio<br>AlCAnCe: 50 m | e un objeto, cri<br>ubrirá un área m<br>icos por nivel.<br>lo necesario pa<br>puede incluso<br>r. Las criaturas<br>es real, aunque<br>de INT para da<br>os una criatura<br>aparece de inme<br>están tan conve<br>ueden llegar a s<br>n guión determ<br>lanzamiento (i<br>conjuro) y, por<br>enga la concent<br>nista nivel 4)<br>etros CoMpone |
| duraCión: concentración | ts: CAR ni | ega rC |
...
| Este hechizo permite al<br>medio o pequeño le co<br>confianza. La víctima ti<br>de CAR para evitar los e<br>el momento del lanzam<br>por el lanzador o sus a<br>realizar lo que el lanzad<br>actuará como un autóm<br>inmovilizar ani<br>tl: 1 A | lanzador que una criatu<br>nsidere como un amig<br>ene derecho a una tirada<br>fectos, con un +5 de bon<br>iento está siendo atacada<br>liados. Si falla, se sentir<br>or sugiera, pero bajo nin<br>ata bajo el control del co<br>mal (druida nivel 2)<br>lCAnCe: 15 metros CoMpo | ra de tamaño<br>o y aliado de<br>de salvación<br>ificación si en<br>o amenazada<br>á inclinada a<br>gún concepto<br>njurador.<br>nentes: V y S |
| duraCión: 1 asalto/nivel | ts: SAB niega | rC: sí |
| Este conjuro nos perm<br>elección, el cual perma<br>que plenamente consci<br>El animal en cuestión<br>ción de SAB para evita<br>inmovilizar per<br>nivel 3, mago nivel 3<br>tl: 1 A | itirá retener a un anim<br>necerá inmóvil en su p<br>ente de lo que ocurre a<br>tiene derecho a una tir<br>r los efectos del conjuro<br>sona (clérigo nivel 2<br>)<br>lCAnCe: 40 metros CoMpo | al de nuestra<br>osición, aun-<br>su alrededor.<br>ada de salva-<br>.<br>, ilusionista<br>nentes: V y S |
| duraCión: 1 asalto/nivel | ts: SAB niega | rC: no |
| Este conjuro permite<br>zándola en su posició<br>monstruos mayores qu<br>dos por este hechizo. A<br>guirá respirando norm<br>ocurre a su alrededor, a<br>ción alguna. La víctim<br>tirada de salvación de<br>invisibilidad (ilusi<br>tl: 1 | inmovilizar a una cri<br>n. Los muertos viviente<br>e un ogro o un trol no<br>l quedar inmovilizada,<br>almente, siendo conscie<br>unque no podrá hablar<br>a de este conjuro tiene d<br>SAB para evitar quedar<br>onista nivel 2, mago n<br>AlCAnCe: toque CoMpo | atura, parali-<br>s y todos los<br>se ven afecta-<br>la criatura se-<br>nte de lo que<br>ni realizar ac-<br>erecho a una<br>paralizada.<br>ivel 2)<br>nentes: V y S |
| duraCión: ver texto | ts: no | rC: sí |
...
| La persona tocada po<br>muertos vivientes. L<br>como esqueletos y zo<br>tada por el conjuro.<br>inteligentes, como va<br>tirada de salvación d<br>invisibilidad de<br>nivel 7)<br>tl: 1 | r el lanzador<br>os muertos v<br>mbis, no pod<br>No obstante<br>mpiros o liche<br>e INT.<br>masas (ilu<br>AlCAnCe: 15 me | se tornar<br>ivientes<br>rán ver a<br>, muerto<br>s, tendrá<br>sionista<br>tros Co |
| duraCión: ver texto | ts: no |  |
| Este conjuro funcion<br>que el número de cria<br>al incrementarse el áre<br>invisibilidad en<br>nivel 3)<br>tl: 1 | a igual que in<br>turas afectadas<br>a afectada hast<br>grupo (ilu<br>AlCAnCe: ver te | visibilida<br>puede se<br>a los 15<br>sionista<br>xto Co |
| duraCión: ver texto | ts: no |  |
| Este conjuro tiene el<br>lidad, pero afectará a<br>metros alrededor del<br>se aleje más allá de 3<br>de inmediato. Si el co<br>decide atacar o lanzar<br>sibilidad se disipará<br>invisibles no pueden<br>invisibilidad ex<br>nivel 5)<br>tl: 4 | mismo efecto<br>toda criatura<br>lanzador. Tod<br>metros del la<br>njurador o cu<br>un nuevo co<br>de inmediato<br>verse las unas<br>tendida d<br>AlCAnCe: toq | que el c<br>dentro d<br>a person<br>nzador s<br>alquiera<br>njuro, el<br>para tod<br>a las otr<br>e deja<br>ue C |
| duraCión: 1 día/nivel | ts: INT nieg | a |
| Este hechizo solo fun<br>que no midan más de<br>Los efectos del conjur<br>ralmente invisible. La<br>si el objeto se mueve<br>dicho objeto tiene éxi<br>invisibilidad me<br>tl: 1 | ciona sobre ob<br>3 metros de<br>o hacen que e<br>invisibilidad<br>o una criatura<br>to en una tira<br>jorada (ilus<br>AlCAnCe: toq | jetos inm<br>alto x 3<br>l objeto<br>termina<br>que bus<br>da de sal<br>ionista<br>ue Co |
| duraCión: 1 min<br>+1 asalto/nivel | ts: no |  |
...
| 16-17 |  | 2d4 as |
| 18 o más |  | 1d4 as |
| Los minotauros son<br>Leer magia (ilusi<br>tl: 1 | inmunes a este<br>onista nivel 1<br>AlCAnCe: - | conjuro.<br>, mago ni<br>CoMp |
| duraCión: 10 min/nivel | ts: no |  |
...
| Este conjuro otorga al lan<br>da, la habilidad de comp<br>durante el tiempo que du<br>Lentificar veneno<br>tl: 1 Al | zador, o a cual<br>render y hablar<br>re este encanta<br>(clérigo nivel<br>CAnCe: toque | quier criatu<br>cualquier<br>miento.<br>2, druida<br>CoMponent | ra elegi-<br>lenguaje<br>nivel 2)<br>es: V y S |
| duraCión: 1 hora/nivel ts | : CON niega | rC: s | í |
| Este conjuro es capaz de ra<br>el organismo de la criatur<br>mismo (evitando el empeo<br>el hechizo no restaura pun<br>toxina. Si por alguna razón<br>del conjuro, tiene derecho<br>Leones ilusorios (il<br>tl: 2 AlC | lentizar los efec<br>a afectada dura<br>ramiento del bla<br>tos de vida perd<br>el blanco desea<br>a una tirada de s<br>usionista 6)<br>AnCe: 10 metros | tos de un ve<br>nte la dura<br>nco). Aún c<br>idos por efe<br>resistirse a lo<br>alvación de<br>CoMponent | neno en<br>ción del<br>on todo,<br>cto de la<br>s efectos<br>CON.<br>es: V y S |
| duraCión: 6 asaltos t | s: INT niega | rC: s | í |
| Tras una orden y un cha<br>enormes leones aparecen c<br>mostrarán amenazantes, r<br>entre el lanzador y sus alia<br>su tirada de salvación de I<br>y luchará contra ellos co<br>leones atacan usando los<br>iniciativa), como si fuera e<br>po a cuerpo. Cada ataque<br>por mordisco. Los leones<br>suelo ensangrentados y m<br>Levitar (mago nivel<br>tl: 1<br>15 | squido de dedo<br>orriendo de la<br>ugiendo y mov<br>dos. Cualquier<br>NT, creerá que l<br>mo si fueran un<br>valores del lanza<br>ste el que atacar<br>con éxito causa<br>tienen una CA<br>oribundos si suf<br>2)<br>AlCAnCe:<br>metros o toque | s del lanza<br>nada. Los f<br>iéndose alr<br>espectador<br>os felinos s<br>enemigo<br>dor (incluy<br>a con un ar<br>3d6 puntos<br>de 18 y c<br>ren cualqui<br>CoMponent | dor, dos<br>elinos se<br>ededor y<br>que falle<br>on reales<br>más. Los<br>endo su<br>ma cuer-<br>de daño<br>aerán al<br>er daño.<br>es: V y S |
| duraCión: 10 min/nivel t | s: INT niega | rC: s | í |
| Empleando este hechizo<br>duce que el receptor u o<br>arriba y abajo, a volunta<br>podrá desplazarse horizo<br>Libertad de movim<br>nivel 4)<br>tl: 1 Al | se crea un efec<br>bjeto elegido le<br>d del conjurado<br>ntalmente por<br>iento (cléri<br>CAnCe: toque | to mágico<br>vite sobre<br>r. No obst<br>sí mismo.<br>go nivel 4<br>CoMponent | que pro-<br>el suelo,<br>ante, no<br>, druida<br>es: V y S |
| duraCión: 10 min/nivel | ts: no | rC: s | í |
...
| Este conjuro cr<br>metro que sur<br>dirigirse rápida<br>de sí una estel<br>por el lanzado<br>Los meteoritos<br>centrarse en u<br>de los meteori<br>salvación. Las<br>metros de radio<br>que pueden red<br>de DES exitosa<br>Localizar<br>tl: 1 | ea 4 esferas pé<br>girán de la m<br>mente hacia e<br>a flamígera y e<br>r (siempre de<br>pueden golp<br>n solo punto.<br>tos sufren 9d6<br>criaturas afect<br>), sufren 1d4 x<br>ucirse a la mit<br>(cada meteori<br>criatura (<br>AlCAnCe: | treas ígn<br>ano exte<br>l objetiv<br>stallando<br>ntro del<br>ear objeti<br>Las criat<br>puntos<br>adas por<br>10 punt<br>ad con u<br>to debe s<br>mago niv<br>150 metros | eas de 1 me<br>ndida del<br>o fijado, de<br>en el pun<br>alcance de<br>vos diferen<br>uras en la<br>de daño si<br>la explosi<br>os de daño<br>na tirada d<br>alvarse por<br>el 4)<br>CoMpone |
| duraCión: 10 min | /nivel ts | : no | rC |
...
| Este conjuro nos per<br>lanzador sepa de ant<br>zo ofrecerá al lanzad<br>objeto deseado, o la<br>ción que se tenga del<br>El reverso de este co<br>sibles usos del conjur<br>magia adivinatoria.<br>Locura (ilusionist<br>tl: 1 | mite locali<br>emano có<br>or la direcc<br>de aquel m<br>mismo.<br>njuro perm<br>o de local<br>a nivel 7<br>AlCAnCe: 1 | zar un objeto,<br>mo es dicho o<br>ión en la que<br>ás parecido se<br>ite ocultar u<br>izar objeto o<br>)<br>5 metros CoM | si<br>bje<br>se<br>gú<br>n o<br>de<br>po | empre que el<br>to. El hechi-<br>encuentra el<br>n la descrip-<br>bjeto de po-<br>otro tipo de<br>nentes: V y S |
| duraCión: permanente | ts: INT | niega |  | rC: sí |
...
| Este conjuro con<br>ca, dotándola de<br>Sin embargo, lo<br>no afectarán a la<br>armas y armadu<br>de las mismas d<br>ma adecuada an<br>kilos de madera<br>Mano apres<br>9, mago nivel 7<br>tl: 1 | vierte<br>una r<br>s conju<br>made<br>ras de<br>eben s<br>tes del<br>por ni<br>ador<br>) | a la madera común en m<br>esistencia al fuego como<br>ros que afectan al meta<br>ra férrea. El lanzador pu<br>este material, aunque lo<br>er esculpidos para que te<br>encantamiento. El conju<br>vel del lanzador.<br>a de Fistan (ilusio<br>AlCAnCe:<br>CoMp<br>3 metros/nivel |
| duraCión: 1 asalto/n | ivel | ts: ver texto |
...
| Una vez lanzado e<br>tas de los dedos de<br>arrasan lo que encu<br>2 metros. Salen 10<br>un arco aproximad<br>dentro del área de e<br>golpe + 1 PG por n<br>flamable dentro de<br>sin ningún tipo de<br>Marabunta (d<br>tl: 1 | ste conjuro, bro<br>l lanzador una<br>entran a su pas<br>chorros en for<br>o de 120 grados<br>fecto del conju<br>ivel del lanzado<br>la zona afectad<br>tirada de salvac<br>ruida nivel 7)<br>AlCAnCe: 45 me | tan a t<br>s llamas<br>o hasta<br>ma de a<br>. Cualq<br>ro sufri<br>r. Cual<br>a arde<br>ión.<br>tros C |
| duraCión: 1 min/nivel | ts: no |  |
...
| El lanzador pued<br>y recibir respuest<br>que el individuo r<br>que se ha pronun<br>audible, alguien<br>Un conjuro de sil<br>Mensaje oní<br>tl: 1 min | e susurrar un me<br>a a muchos metro<br>eceptor del mensa<br>ciado el mismo. Si<br>cercano al lanzad<br>encio bloquea los<br>rico (ilusionista<br>AlCAnCe: ver te | nsaje a un ú<br>s de distanc<br>je entienda la<br>bien el men<br>or podría lee<br>efectos de es<br>nivel 5)<br>xto CoMpo |
| duraCión: ver text | o ts: no |  |
...
| Este conjuro afecta a to<br>de 8 x 8 metros que no<br>CAR. El pánico y el ter<br>que huyan del lanzado<br>criaturas son acorralada<br>el conjurador, lo harán<br>todas sus tiradas.<br>Mnemotecnia de<br>tl: 10 min. Al | das las cri<br>superen u<br>ror azotan<br>r lo más r<br>s y se ven<br>aplicando<br>Fistan<br>CAnCe: pers | aturas dent<br>na tirada d<br>sus corazo<br>ápido posi<br>obligadas a<br>una penali<br>(mago niv<br>onal CoM |  |
| duraCión: ver texto | ts: no |  | rC: no |
...
| duraCión: ve | r texto | ts: ver texto | rC: |
| El lanzador g<br>los siguientes<br>de fuego, mu<br>nube apestos<br>centelleante,<br>do tiene su ef<br>parámetros: a<br>embargo, una<br>efectos del co<br>duración, de<br>Moldear<br>tl: 1 | enera una<br>conjuros:<br>ro de fuer<br>a, nube a<br>telaraña o<br>ecto norm<br>lcance, du<br>tirada de<br>njuro imit<br>su fuerza,<br>sombras<br>Al | ilusión prácticame<br>bola de fuego, co<br>za, muro de hielo<br>niquiladora, proye<br>tormenta de hielo.<br>al completo, así co<br>ración, tiradas de<br>salvación exitosa<br>ado al 40% (un 4<br>etc.).<br>(ilusionista nive<br>CAnCe: 50 metros | nte real<br>no de fr<br>, muro<br>ctil mág<br>El hech<br>mo el re<br>salvació<br>de INT r<br>0% del d<br>l 4)<br>CoMponen |
| duraCión: 1 asal | to/nivel | ts: ver texto | rC: |
| El lanzador<br>monstruos q<br>tros del lanza<br>criaturas por<br>del lanzador.<br>una de las il<br>el tamaño d<br>Las ilusiones<br>normales de l<br>Las criaturas<br>migos reales<br>salvación de<br>ilusiones infl<br>des y debilida<br>tirada de salv<br>CA, el daño<br>enfrenten se r<br>que el conju<br>siendo válida<br>Moldear<br>tl: 1 | moldea ilu<br>ue atacarán<br>dor. Medi<br>un valor t<br>El conjur<br>usiones, si<br>e las criat<br>tienen so<br>a criatura<br>atacadas p<br>a menos<br>INT. Si la<br>igen daño<br>des habit<br>ación tien<br>que causa<br>educe a u<br>ro funcio<br>la del pro<br>sombras<br>Al | siones casi perfect<br>a sus enemigos a<br>ante este conjuro s<br>otal en dados de g<br>ador elige la form<br>es un goblin, un<br>uras debe ser peq<br>lo un 20% de los<br>que copian.<br>or las ilusiones cr<br>que tengan éxito<br>tirada de salvació<br>normal y tienen<br>uales del monstruo<br>e éxito, las habilid<br>n, etc., de las ilus<br>n 20% de los valor<br>ne, en el área deb<br>pio lanzador.<br>mayor (ilusion<br>CAnCe: 50 metros | as de un<br>no más<br>e pueden<br>olpe igu<br>a que ad<br>enano,<br>ueño o<br>puntos<br>eerán qu<br>en una<br>n es un<br>todas las<br>que cop<br>ades esp<br>iones a l<br>es habitu<br>e haber<br>ista niv<br>CoMponen |
| duraCión: 1 asal | to/nivel | ts: ver texto | rC: |
...
| Este conjuro<br>como montu<br>de tamaño hu<br>rango de mov<br>el dragón y su<br>que es una m<br>Mordisco<br>tl: 1 | crea<br>ra po<br>man<br>imie<br>pere<br>era il<br>de | un dragón<br>r el lanzado<br>o. El dragón<br>nto de 20 m<br>n una tirada<br>usión.<br>dragón (i<br>AlCAnCe: 8 | il<br>r y<br>vue<br>etr<br>de<br>lusi<br>me | usorio q<br>hasta ot<br>la, cami<br>os. Las c<br>salvació<br>onista<br>tros C | ue puede usarse<br>ras tres criaturas<br>na o nada con un<br>riaturas que vean<br>n de INT sabrán<br>nivel 2)<br>oMponentes: V y S |
| duraCión: insta | ntáneo | ts: INT | nie | ga | rC: sí |
...
| Este conjuro<br>máximo de 2<br>centímetros de<br>el lanzador y s<br>peren una tira<br>impenetrable<br>magia, desinte<br>las criaturas af<br>o conjuros dis<br>una nueva tira<br>ataque rebotad<br>fallará, pero n<br>Muro de e<br>tl: 1 | crea la ilusión<br>metros cuadrado<br>espesor en un<br>us contrincante<br>da de salvación<br>que solo puede<br>grar o un hechiz<br>ectadas tratan<br>tintos a los me<br>da de salvación<br>o desde el espe<br>o les afectará a e<br>spinas (druid<br>AlCAnCe: | de un espejo pe<br>s por nivel de la<br>pasillo, portal o<br>s. Para las víctim<br>de INT, el espejo<br>derribarse med<br>o o poder simila<br>de atacar al espe<br>ncionados antes<br>de INT, recibir<br>jo. Si tienen éxi<br>llos.<br>a nivel 5)<br>50 metros CoMpo |
| duraCión: 10 min | /nivel ts: | no |
...
| Este conjuro crea u<br>sobre una superficie<br>laterales o el suelo<br>caerá con un 50%<br>atrás. Las criaturas<br>nar el área con un<br>otra forma recibirá<br>centímetros de gros<br>de 2 x 2 metros por<br>Este muro no pue<br>por un objeto, estr<br>es susceptible de s<br>óxido, etc.) o cualq<br>cada 3 centímetros<br>neutralizar<br>nivel 3, ilusionist<br>tl: 1 | n muro plano d<br>sólida que perm<br>para permanec<br>de probabilida<br>amenazadas po<br>a tirada de salv<br>n 10d6 puntos d<br>or por cada cua<br>nivel del lanza<br>de invocarse en<br>uctura o criatur<br>er atacado por<br>uier otro modo<br>de ancho, el m<br>n<br>veneno (c<br>a nivel 5)<br>AlCAnCe: toq | e hierro que de<br>ita al muro fa<br>er erguido. De<br>des hacia dela<br>r la caída pue<br>ación de DES<br>e daño. El m<br>tro niveles de<br>dor de ancho<br>una ubicaci<br>a. Una vez crea<br>los elementos<br>mundano o<br>uro dispone<br>lérigo nivel<br>ue CoMpo | be co<br>lcars<br>otra<br>nte<br>den a<br>exit<br>uro se<br>l lanz<br>y alto<br>ón o<br>do, e<br>(cor<br>mági<br>de 30<br>4,<br>nentes |
| duraCión: permanent | e ts: no | r | C: no |
...
| Muro de v<br>modo de b<br>tros de altu<br>impedirá e<br>que un águ<br>o jabalinas,<br>impide el<br>que no det<br>Muro pr<br>tl: | iento perm<br>arrera, cub<br>ra. El vien<br>l paso de cr<br>ila). Así mi<br>serán desv<br>paso de gas<br>endrá a una<br>ismático<br>1 A | ite al lanzador<br>riendo 6 metro<br>to huracanado<br>iaturas volador<br>smo, flechas y v<br>iadas por efecto<br>es y criaturas en<br>criatura incorp<br>(druida nivel 9<br>lCAnCe: 15 metros | crear una ve<br>s de largo p<br>que forma e<br>as pequeñas<br>irotes, inclu<br>del viento.<br>forma gase<br>órea).<br>, ilusionista<br>CoMponen |  |
| duraCión: 10 | min/nivel | ts: ver texto | rC: ver |  |
| Este conjur<br>prismática,<br>ma de una<br>máximo de<br>medio met<br>lanzar este<br>niebla<br>ilusionista<br>tl: | o actúa de<br>salvo que<br>pared. Las<br>1,5 metros<br>ro de altura<br>conjuro en<br>de osc<br>nivel 1)<br>1 | manera similar<br>en lugar de un<br>dimensiones d<br>de anchura por<br>por nivel del l<br>el área que ocu<br>urecimiento<br>AlCAnCe: ver texto | al conjuro<br>a esfera tom<br>el muro ser<br>nivel del la<br>anzador. No<br>pe una criat<br>(druida<br>CoMponen |  |
| duraCión: 1 | min/nivel | ts: no | rC: | no |
...
| duraCión: 1 min/nivel | ts: no |  |
| Este hechizo invoc<br>de diámetro centr<br>la visión, incluyen<br>sión. Cualquier cri<br>moverse a una déc<br>Además, todos los<br>penalización de -2<br>área basado en el fu<br>en un mismo asalt<br>viento muy fuerte<br>nube aniquila<br>tl: 1 | a una esfera de<br>ada en el lanz<br>do la visión en<br>atura que inte<br>ima parte de<br>ataques dentr<br>a golpear y al<br>ego que cause<br>o, destruirá inm<br>también puede<br>dora (mago<br>AlCAnCe: 50 m | niebla densa<br>ador. La esfe<br>la oscuridad<br>nte atravesarl<br>su rango de<br>o de la niebl<br>daño. Cualqu<br>más de 12 pu<br>ediatamente<br>dispersarla.<br>nivel 5)<br>etros CoMpo |
| duraCión: 1 turno/nivel | ts: ver tex | to |
...
| duraCión: 1 asalto | /nivel | ts: n | o | r |
| Este conjuro al<br>con una luz r<br>un área de 3 m<br>al lanzador. La<br>tirada de salva<br>mientras haya<br>onda sóni<br>tl: 1 | tera l<br>oja int<br>etros<br>s cria<br>ción<br>otros<br>ca (c | os ojos del<br>ensa. Este<br>de ancho<br>turas con<br>de INT nu<br>enemigos c<br>lérigo niv<br>AlCAnCe: 1 | lanzador, q<br>fulgor es c<br>por 6 metr<br>2 DG o me<br>nca atacar<br>ontra los q<br>el 1)<br>5 metros C | ue pas<br>apaz d<br>os de<br>nos q<br>án al<br>ue luc<br>oMpon |
| duraCión: instan | táneo | ts: ver | texto | r |
| El lanzador es<br>nica, que pued<br>metros frente<br>de daño y debe<br>no quedar atur<br>durante 1 asalt<br>página sec<br>tl: 10 min | capa<br>e dañ<br>a él. T<br>realiz<br>dida (<br>o.<br>reta | z de provo<br>ar a criatu<br>oda criatur<br>ar una tira<br>no podrá l<br>p<br>(ilusionis<br>AlCAnCe: | car una p<br>ras dentro<br>a afectada<br>da de salva<br>levar a cabo<br>ta nivel 3<br>toque C | oderos<br>del alc<br>sufre<br>ción d<br>ning<br>)<br>oMpon |
| duraCión: ver | texto | ts: n | o | r |
| Este conjuro pe<br>o pergamino, d<br>ta por cualquie<br>incluso para es<br>sencia, pero sin<br>y volver a ocul<br>mando. La úni<br>es mediante alg<br>combinación d<br>palabra d<br>tl: 1 | rmite<br>e mod<br>r otro t<br>conder<br>afecta<br>tar el<br>ca for<br>ún co<br>e visió<br>e reg | enmascarar<br>o que parez<br>exto. El lan<br>unas runa<br>r a su efica<br>texto origi<br>ma de forz<br>njuro que d<br>n verdader<br>reso (clé<br>AlCAnCe: v | la informac<br>ca que está e<br>zador pued<br>s explosivas,<br>cia. El lanz<br>nal median<br>ar el acceso<br>isipe la ilus<br>a y lenguas.<br>rigo nivel 6<br>er texto C | ión de<br>n blan<br>e usar<br>ocult<br>ador p<br>te una<br>al me<br>ión o<br>, drui<br>oMpon |
| duraCión: instan | táneo | ts: ver | texto | r |
...
| 3 | 1-60 | 2d4 asaltos |
| 61 | -120 | 1d4 asaltos |
| Una criatura<br>hechizo.<br>palabra p<br>mago nivel 8<br>tl: 1 | aturdida no pued<br>oderosa ceg<br>)<br>AlCAnCe: 15 | e actuar mientras<br>ar (ilusionista n<br>metros CoMponen |
| duraCión: ver | texto ts: no | rC: s |
| Este poderoso<br>un área de 10<br>puntos de go<br>ascendente de<br>turas o se sob<br>PG son inmu<br>puntos de gol<br>la ceguera dur<br>100 queda ceg<br>palabra p<br>mago nivel 9<br>tl: 1 | conjuro dejará cie<br>x 10 metros hasta<br>lpe. Las criaturas<br>puntos de golpe<br>repase el límite. L<br>nes. La duración d<br>pe de la criatura af<br>a 1d4 horas, mien<br>ada durante 1d4 +<br>oderosa mat<br>)<br>AlCAnCe: 30 | gas a todas las cria<br>un total combinad<br>se ven afectadas e<br>hasta que no qued<br>as criaturas de más<br>e la ceguera depend<br>ectada: entre 1 y 50<br>tras que si tiene en<br>1 asaltos.<br>ar (ilusionista<br>metros CoMponen |
| duraCión: insta | ntáneo ts: no | rC: s |
| Con una sola<br>la vida de un<br>más de 30 met<br>escuchar la pa<br>seleccionar co<br>grupo antes de<br>esta muere si<br>contra un gru<br>10 metros del<br>tengan 15 pun<br>acumulado de<br>afecta a las cria<br>palabra s<br>tl: 1 | palabra, el conjura<br>solo oponente o de<br>ros, sin importar si<br>labra pronunciada.<br>mo objetivo a una<br>lanzar el hechizo. S<br>tiene 70 puntos de<br>po, matará a todas<br>punto designado p<br>tos de golpe o me<br>140 puntos de golp<br>turas en orden asce<br>agrada/impía<br>AlCAnCe: ve | dor es capaz de aca<br>un grupo de criatu<br>las víctimas son ca<br>El lanzador debe d<br>criatura individual<br>i apunta a una sola<br>golpe o menos. Si<br>las criaturas en un<br>or el lanzador, siem<br>nos, y hasta sumar<br>e como máximo. El<br>ndente de puntos d<br>(clérigo nivel 7)<br>r texto CoMponent |
| duraCión: perm | anente ts: no | rC: s |
| Una vez sea la<br>da en un área<br>los siguientes<br>tabla de<br>dg/nivel | nzado este conjur<br>de 20 metros alred<br>efectos:<br>efectos de p | o, cualquier criatur<br>edor del conjurado<br>alabra sagra<br>efecto |
| 3 o menos |  | Muertos |
| 4-7 | Paraliz | ados 1d4 turnos |
| 8-11 | Atontados 2d4 asalto<br>red | s, -4 para golpear, movi<br>ucido al 50% |
...
| duraCión: permanen | te | ts | : no | r | C: no |
| Este conjuro crea<br>perficie similar d<br>30 centímetros de<br>los objetos físico<br>para ocultar pozo<br>de detección que<br>mente. Tocar o s<br>ilusoria, aunque<br>pasadizo ar<br>tl: 1 | la<br>e h<br>gr<br>s l<br>s, t<br>no<br>on<br>eso<br>ca | ilusión d<br>asta 9 me<br>osor. Pare<br>o atraves<br>rampas o<br>se basen<br>dear la s<br>no hace<br>no (mag<br>AlCAnCe: | e una par<br>tros cuad<br>ce absolu<br>arán sin<br>puertas,<br>en la vist<br>uperficie<br>que la ilu<br>o nivel 5<br>15 metros | ed, suelo,<br>rados de<br>tamente r<br>dificultad<br>todas las<br>a funcion<br>revela su<br>sión desa<br>)<br>CoMpon | techo o su-<br>largaria por<br>eal, aunque<br>. Si se usa<br>habilidades<br>an normal-<br>naturaleza<br>parezca.<br>entes: V y S |
| duraCión: 1 hora/ni | vel | ts | : no | r | C: no |
...
| Un patrón bril<br>hechiza a las cri<br>diámetro. El nú<br>24 DG en total,<br>de DG. A mismo<br>cercanas al lanz<br>criaturas afectad<br>más allá de defe<br>rompe el encant<br>a una tirada de<br>conjuro. Este co<br>Mientras el conj<br>el patrón lumin<br>las criaturas baj<br>permanecer den<br>lleva a las criatu<br>ganan la oportu<br>patrón hip<br>tl: 1 | lante de<br>aturas de<br>mero máx<br>empezand<br>número<br>ador son<br>as no po<br>nderse si s<br>amiento.<br>salvación<br>njuro no a<br>uro esté a<br>oso a raz<br>o su influj<br>tro del áre<br>ras hechi<br>nidad de<br>nótico<br>AlCA | colores entrelazad<br>ntro de una esfera<br>imo de criaturas a<br>o por aquellas con<br>de dados de golpe, l<br>las afectadas en p<br>drán moverse ni r<br>on atacadas, mome<br>Todas las criaturas<br>de INT para evita<br>fectará a las criatu<br>ctivo, el lanzador<br>ón de 10 metros p<br>o seguirán a las lu<br>a de efecto. Si este<br>zadas hacia un te<br>una nueva tirada d<br>(ilusionista nivel<br>nCe: 15 metros C |
| duraCión: concentra | ción ts | : INT niega |
| El lanzador invo<br>tante movimient<br>lo mire. El hechi<br>área de 8 x 8 met<br>zador. Las víctim<br>INT para evitar l<br>puede afectar a m<br>del lanzador, en<br>influjo del conju<br>El lanzador no<br>este hechizo, pe<br>nada más) para<br>ven afectadas po<br>pequeño re<br>tl: 1 | ca un patró<br>o que atra<br>zo afectar<br>ros centra<br>as tienen d<br>os efectos d<br>ás de un t<br>orden asce<br>ro no pod<br>necesita<br>ro debe ge<br>mantenerl<br>r el patró<br>fugio d<br>AlCA | n de colores centell<br>e y fascina a cualq<br>á a todas las criatur<br>da en el punto desig<br>erecho a una tirad<br>el conjuro. En cual<br>otal de 2d4 DG má<br>ndente de DG. Las<br>rán llevar a cabo ni<br>pronunciar palab<br>sticular y concent<br>o activo. Las criatu<br>n hipnótico.<br>e nébula (mag<br>nCe: ver texto Co |
...
| Este conjuro<br>cas, de form<br>piedras<br>tl: 1 | habilitará al<br>a similar al co<br>puntiagud<br>AlCAn | lanzador<br>njuro habl<br>as (druida<br>Ce: 50 metro | para hablar<br>ar con las<br>nivel 4)<br>s CoMpon |
| duraCión: 10 | min/nivel ts | : ver texto | r |
...
| El conjurador y sus<br>a sus tiradas de ata<br>contrincantes serán<br>tiradas. El área de<br>radio desde la posic<br>polimorfar (il<br>tl: 1 | aliados obte<br>que, salvació<br>penalizados<br>efecto del c<br>ión del lanz<br>usionista ni<br>AlCAnCe: ve | ndrán un bonif<br>n y daño, mien<br>con un -1 en<br>onjuro es de 1<br>ador.<br>vel 8, mago ni<br>r texto CoMpo |
| duraCión: ver texto | ts: ver te | xto |
...
| Este hechizo abre u<br>centímetros de radi<br>zador en su último l<br>depositar hasta siete<br>portados y colocado<br>portal interd<br>nivel 9)<br>tl: 2 | n pequ<br>o conect<br>ugar de<br>objetos<br>s sin da<br>imens<br>AlCAnC | eño agujero dimens<br>ado con el dormito<br>residencia. El conju<br>en dicho portal, que<br>ño en el suelo del do<br>ional (clérigo niv<br>e: 15 metros CoMpon | ional de 25<br>rio del lan-<br>rador puede<br>serán trans-<br>rmitorio.<br>el 9, mago<br>entes: V y S |
| duraCión: ver texto | t | s: no r | C: no |
...
| Este es el conjuro de<br>Cuando se usa permit<br>la hemorragia y evitan<br>y posibles infecciones<br>cae por debajo de los 0<br>producir llama (<br>tl: 1 A | curación más bá<br>e restañar herid<br>do la pérdida de<br>(por ejemplo, cu<br>puntos de golp<br>druida nivel 2<br>lCAnCe: personal | sico que se c<br>as abiertas co<br>más puntos<br>ando un ave<br>e).<br>)<br>CoMponente |
| duraCión: 1 min/nivel | ts: no | rC: sí |
| Al lanzar este hechizo,<br>una antorcha, aparece e<br>dañará al lanzador, per<br>les combustibles que e<br>La llama se puede utili<br>dor debe tocar al blanc<br>más 1 punto adicional<br>llama también se pued<br>prender sobre cualquie<br>de impacto y causando<br>que si el blanco es una<br>con éxito hace que el c<br>protección cont<br>mago nivel 1)<br>tl: 1 | una llama brill<br>n la mano del la<br>o es real y puede<br>ntren en contact<br>zar para atacar, e<br>o para causarle<br>por cada dos niv<br>e lanzar hasta 1<br>r material com<br>el mismo daño<br>criatura. Cualqu<br>onjuro termine<br>ra el mal/b<br>AlCAnCe: toque | ante, del tam<br>nzador. La ll<br>prender en m<br>o con ella.<br>n cuyo caso e<br>1d4 puntos d<br>eles del lanza<br>5 metros, pu<br>bustible en el<br>que un ataqu<br>ier acción de<br>de inmediato.<br>ien (clérigo<br>CoMponente |
...
| El receptor de este c<br>no mágicos, tales co<br>protección c<br>nivel 3)<br>tl: 1 | onjuro será inmun<br>mo virotes de ball<br>ontra los e<br>AlCAnCe: toque | e a pequeñ<br>esta, dardo<br>lement<br>CoMpo | os proyectiles<br>s o flechas.<br>os (druida<br>nentes: V y S |
| duraCión: 10 min/nive | l ts: no |  | rC: sí |
| La criatura receptor<br>to a elección del lan<br>electricidad/rayo, s<br>de daño por nivel<br>importar si la fuent<br>proyección as<br>ilusionista nivel<br>tl: 30 min | a podrá ganar prote<br>zador: ácido, agua<br>onido/aire. El con<br>del lanzador del ele<br>e del mismo es má<br>tral (clérigo n<br>9, mago nivel 9)<br>AlCAnCe: ver text | cción cont<br>, frío/hielo<br>juro absor<br>mento sele<br>gica o conv<br>ivel 9, dr<br>o CoMpo | ra un elemen-<br>, calor/fuego,<br>be 12 puntos<br>ccionado, sin<br>encional.<br>uida nivel 9,<br>nentes: V y S |
| duraCión: ver texto | ts: no |  | rC: no |
...
| duraCión: ver texto | ts: | no rC | : no |
| Este útil conjuro cre<br>zador atravesar mur<br>Esta puerta o pasaje<br>una anchura de 2 m<br>para el lanzador y s<br>aparecerá cuando ut<br>al salir del pasaje. E<br>lanzador haya hecho<br>igual a 1 por cada<br>zador lo desea, pod<br>otra criatura de su e<br>acción contará com<br>la puerta, ni trasmit<br>puede anularse con<br>un conjuro de disipa<br>esta criatura será des<br>puerta dimens<br>tl: 1 | a un porta<br>os de pie<br>podrá tene<br>etros. La p<br>olo él pod<br>ilice la pu<br>l conjuro<br>uso de la<br>dos nivele<br>rá atravesa<br>lección (de<br>o dos usos.<br>e la luz o<br>un conjuro<br>r magia c<br>pedida vio<br>ional (<br>AlCAnCe: 1 | l etéreo que permi<br>dra, yeso, ladrillo<br>r una longitud de<br>uerta de fase solo<br>rá activarla. El lan<br>erta para aparecer<br>es permanente h<br>puerta un númer<br>s del conjurador.<br>r la puerta en co<br>tamaño humano<br>No se puede ver<br>el sonido. La pue<br>de disipar magia.<br>uando alguien está<br>lentamente por do<br>mago nivel 4)<br>50 metros CoMpo | tirá al lan-<br>o madera.<br>3 metros y<br>será visible<br>zador des-<br>de nuevo<br>asta que el<br>o de veces<br>Si el lan-<br>mpañía de<br>), pero esta<br>a través de<br>rta de fase<br>Si se lanza<br>usándola,<br>nde entró.<br>nentes: V |
| duraCión: instantáneo | ts: | no rC | : no |
...
| Este hechizo cura l<br>de origen normal<br>ni los ojos que se h<br>El reverso de este<br>sin armas) quede<br>rador. Además de<br>-10 a las tiradas d<br>podrá sumar su b<br>su rango de movi<br>DES e iniciativa.<br>salvación de CO<br>Quitar el mi<br>tl: 1 | a ceguera<br>o mágico.<br>ayan perd<br>hechizo h<br>cegada o<br>los efecto<br>e ataque,<br>onificado<br>miento y<br>La víctim<br>N para evi<br>edo/c<br>AlC | o la sordera de una cria<br>El hechizo no restaura<br>ido, pero los cura si est<br>ace que la criatura toc<br>ensordecida, a elección<br>s obvios, una criatura c<br>un -2 a su CA a la q<br>r de DES, ve reducido<br>sufre un -4 a las tirad<br>a tiene derecho a un<br>tar los efectos de este<br>ausar miedo (clér<br>AnCe: toque CoMpon |
| duraCión: ver text | o | ts: no r |
...
| Este letal c<br>que falle la<br>éxito en la<br>daño por n<br>Rayo de<br>tl: | onjuro ma<br>tirada de<br>misma, la<br>ivel del la<br>bilitado<br>1 | tará insta<br>salvació<br>víctima<br>nzador.<br>r de K<br>AlCAnCe: 1 | ntáneamen<br>n de CAR.<br>sufrirá 3d<br>arkemis<br>5 metros | te a to<br>En ca<br>6 más<br>h (ma<br>CoMpon |
| duraCión: 1 | asalto/nivel | ts: CON | niega | r |
...
| El conjuro de r<br>no más de 25 p<br>do familiares an<br>mensaje, por mu<br>destinatario de<br>de existencia, el<br>de CAR para lo<br>Reclusión (ilu<br>tl: 3 | ecado nos<br>alabras a u<br>imales, qu<br>y lejos qu<br>nuestro me<br>lanzador<br>grar que el<br>sionista<br>AlC | permitirá rem<br>n individuo c<br>e serán capaces<br>e se encuentren<br>nsaje se encue<br>deberá tener é<br>mensaje alcan<br>nivel 7, mago<br>AnCe: toque | itir un<br>onocid<br>de co<br>. No o<br>ntra en<br>xito en<br>ce a su<br>nivel<br>CoMp | mensaje de<br>o, incluyen-<br>mprender el<br>bstante, si el<br>otro plano<br>una tirada<br>objetivo.<br>7)<br>onentes: V |
| duraCión:<br>1 día/nivel | ts | : ver texto | r | C: no |
| Este potente co<br>munidad total<br>y/o artefactos a<br>no desea recibir<br>tirada de salvaci<br>Reencarnar<br>tl: 10 min | njuro gara<br>a conjuros<br>divinatorio<br>los efectos<br>ón de CA<br>(druida ni<br>AlC | ntiza al recepto<br>de escudriña<br>s de cualquier<br>del conjuro, t<br>R para evitarlo.<br>vel 4)<br>AnCe: toque | r u ob<br>miento<br>tipo.<br>iene de<br>CoMpo | jeto una in-<br>o similares<br>Si el blanco<br>recho a una<br>nentes: V y S |
| duraCión: perman | ente | ts: no | r | C: no |
...
| duraCión: permanente | ts: no | r |
| El lanzador podrá, g<br>dades cercenadas, h<br>por motivos muy d<br>mente 1d8 puntos d<br>Las extremidades re<br>ver a ser totalmente<br>Reparar (ilusioni<br>tl: 1 | racias a este c<br>uesos rotos u<br>iversos. El c<br>e golpe + 1 P<br>generadas tard<br>funcionales.<br>sta nivel 0,<br>AlCAnCe: 5 m | onjuro, regene<br>otros órganos<br>onjuro restaura<br>G por nivel d<br>arán 1d12 asa<br>mago nivel 0)<br>etros CoMpon |
| duraCión: 24 horas | ts: no | r |
| Mediante este conju<br>roturas en objetos<br>el eslabón de una<br>una daga mellada,<br>un objeto mágico p<br>ga; además, únicam<br>más de 3 kilos de p<br>conjuro no es mági<br>y no podrá ser devu<br>magia que lo arregl<br>Repeler mader<br>tl: 1 | ro el lanzado<br>comunes. Por<br>cadena rota,<br>etc. En ning<br>or pequeña<br>ente se puede<br>eso. La repar<br>ca, el objeto<br>elto a su est<br>ó.<br>a (druida ni<br>AlCAnCe: ver | r puede repara<br>ejemplo, pod<br>el pomo de u<br>ún caso se pu<br>que sea la rotu<br>reparar un o<br>ación produci<br>queda realmen<br>ado anterior d<br>vel 6)<br>texto CoMpon |
| duraCión: 1 asalto/nivel | ts: no | r |
...
| Este conjuro<br>dedor del la<br>dijas, tales c<br>similares. Si<br>dados de gol<br>el escudo de<br>un tercio en<br>de SAB. Si l<br>recibirán 1d<br>Repulsión<br>tl: 1 | crea una esfera<br>nzador que le p<br>omo arácnidos,<br>las sabandijas<br>pe del nivel del<br>ninguna form<br>DG, tienen der<br>a superan, podr<br>6 puntos de dañ<br>(clérigo nivel<br>AlCAnC | de 6 metros de<br>rotegerá de toda<br>insectos, serpie<br>tienen menos d<br>lanzador, no p<br>a. Las sabandijas<br>echo a una tira<br>án atravesar el<br>o al hacerlo.<br>7)<br>e: ver texto Co | diámetro alre-<br>clase de saban-<br>ntes, roedores y<br>e un tercio en<br>odrán atravesar<br>con al menos<br>da de salvación<br>escudo, aunque<br>Mponentes: V y S |
| duraCión: 1 asa | lto/nivel ts: F | UE niega | rC: sí |
| Este conjuro<br>alrededor de<br>criatura que<br>y deberá rea<br>quedar atur<br>podrá llevar<br>Resistir a<br>nivel 0, ma<br>tl: 1 | crea un campo<br>l lanzador, que<br>intente atraves<br>lizar una tirada<br>dida durante 1d<br>a cabo ninguna<br>los elemen<br>go nivel 0)<br>AlCAnC | de fuerza de 3<br>se desplazará co<br>ar dicho camp<br>de salvación d<br>4 asaltos (dura<br>acción).<br>tos (clérigo n<br>e: 1 persona Co | metros de radio<br>n él. Cualquier<br>o será repelida,<br>e FUE para no<br>nte los que no<br>ivel 0, druida<br>Mponentes: V y S |
| duraCión: 2 | 4 horas t | s: no | rC: sí |
...
| duraCión: permanente | ts: no |  |
| Este conjuro restablece la<br>diendo recuperar las mer<br>sadas por efectos mágico<br>perdido. Aunque no pod<br>perdidos de manera perm<br>tos de CONo niveles per<br>Restablecimiento<br>tl: 1 hora | energía vital d<br>mas temporal<br>s. El hechizo t<br>rán recuperarse<br>anente. El sor<br>didos por cau<br>mayor (clé<br>AlCAnCe: toque | e una única<br>es en caract<br>ambién rec<br>puntos de<br>tilegio no r<br>sa de una re<br>rigo nivel<br>CoMpo |
| duraCión: permanente | ts: no |  |
...
| Este conjuro permite al<br>manos, elfos, enanos, g<br>criaturas humanoides. P<br>criatura revivida solo pu<br>experiencia del lanzado<br>1 puntos de CON de<br>pierde todos sus puntos<br>y no podrá ser revivida<br>estar completo; si algun<br>no se regenera, al igua<br>enfermedad o veneno, e<br>tada. La criatura devuel<br>golpe y no podrá comb<br>Resurrección mayo<br>tl: 1 hora A | lanzad<br>nomos y<br>ara que<br>ede llev<br>r; y la c<br>manera<br>de CO<br>en mod<br>a parte<br>l que si<br>ste segu<br>ta a la v<br>atir o co<br>r (clér<br>lCAnCe: | or devolve<br>halflings,<br>el conjur<br>ar muerta<br>riatura así<br>permanen<br>N, morirá<br>o alguno)<br>hubiera sid<br>la criatu<br>irá actuand<br>ida lo har<br>njurar en<br>igo nivel<br>toque C | r a la vida a hu-<br>así como a otras<br>o tenga efecto, la<br>1 día por nivel de<br>revivida perderá<br>te (si la criatura<br>automáticamente<br>. El cuerpo ha de<br>o amputada, esta<br>ra tuviera alguna<br>o una vez resuci-<br>á con 1 punto de<br>una semana.<br>7)<br>oMponentes: V y S |
| duraCión: permanente | ts: n | o | rC: sí |
| El lanzador es capaz d<br>que no lleve muerta m<br>dor. Para que el conjur<br>pequeña porción del ca<br>puntos de CON cuando<br>o un nivel entero en o<br>de nivel 5 que fuera re<br>un guerrero de nivel 4)<br>todos los puntos de go<br>cualquier extremidad qu<br>forma de toda enfermed<br>latente. No obstante, el<br>característica o niveles q<br>tan potente que es incl<br>vivientes para retornarlo<br>Resurrección verd<br>tl: 3 horas A | e devolv<br>ás de 1<br>o surta<br>dáver. L<br>sea res<br>tro caso<br>sucitad<br>. La cri<br>lpe que<br>e hubie<br>ad o ve<br>resucita<br>ue perd<br>uso pos<br>s a la v<br>adera<br>lCAnCe: | er a la vi<br>0 años po<br>efecto solo<br>a criatura r<br>ucitada si e<br>(por ejem<br>o, volvería<br>atura resu<br>tenía en v<br>ra perdido,<br>neno que<br>do no recu<br>iera en vid<br>ible lanzar<br>ida.<br>(clérigo<br>toque C | da a una criatura<br>r nivel del lanza-<br>se precisará una<br>evivida perderá 2<br>s de primer nivel,<br>plo, un guerrero<br>a la vida como<br>citada recuperará<br>ida, y regenerará<br>curando de igual<br>pudiera estar aún<br>perará puntos de<br>a. Este hechizo es<br>lo sobre muertos<br>nivel 9)<br>oMponentes: V y S |
| duraCión: permanente | ts: n | o | rC: no |
...
| Un cono de m<br>afectando las<br>área de 2 metro<br>más cercanas a<br>número total d<br>Los efectos y d<br>de las víctimas.<br>cientes durante<br>cegadas durant<br>dan aturdidas<br>acción). Las cri<br>resultar afectad<br>una tirada de s<br>Rociada pr<br>tl: 1 | últip<br>ment<br>s de<br>l lan<br>e bl<br>urac<br>Las<br>2d4<br>e 1d<br>dura<br>atur<br>as, y<br>alvac<br>ism | les luces bro<br>es y sentido<br>ancho por 8<br>zador se ve<br>ancos igual a<br>ión del con<br>criaturas de<br>asaltos; las<br>4 asaltos; y la<br>nte 1 asalto (<br>as afectadas d<br>aquellas co<br>ión de SAB<br>ática (ilu<br>AlCAnCe: | ta de la mano d<br>s de las criatura<br>metros de larg<br>n afectadas prim<br>1d4 más el nive<br>juro depende de<br>2 DG o menos<br>criaturas de 3 a<br>s criaturas de 5<br>no pudiendo re<br>eben poder ver<br>n 5 DG o más,<br>para evitar los e<br>sionista nivel<br>15 metros CoM |
| duraCión: ver | texto | ts: ver | texto r |
| salto (mag<br>tl: 1 | o ni | s<br>vel 1)<br>AlCAnCe | : toque Co |
| duraCión: 1 turno | /nive | l ts: | no |
...
| 4 Verde | Tirada | de salvación de C<br>muerte autom | ON (veneno) o<br>ática |
| 5 Azul | Tirad | a de salvación de<br>petrificació | CAR o sufrir<br>n |
| 6 Indigo | Tirad | a de salvación de<br>permanen | SAB o locura<br>te |
| 7 Violeta | Tira | da de salvación d<br>transportado a ot | e INT o verse<br>ro plano |
| Golpeado<br>8<br>por dos rayo<br>Runas explosiva<br>tl: 1 | Tirar d<br>s<br>s (ilusio<br>AlCAnCe | os veces en la tab<br>resultado d<br>nista nivel 3,<br>: toque CoM | la ignorando el<br>e 8<br>mago nivel 3)<br>ponentes: V y S |
| duraCión: ver texto | ts: DES | mitad | rC: sí |
| Una vez desencaden<br>runas mágicas de as<br>mapa u objeto simil<br>por las personas que<br>leer las runas y no es<br>puntos de daño en<br>blancos afectados po<br>rada de salvación de<br>mitad. El objeto prot<br>por la explosión, y<br>salvo que se le protej<br>sanar/dañar<br>ilusionista nivel 9)<br>tl: 1 | ado el co<br>pecto ino<br>ar, estas<br>designe e<br>tá autori<br>un área d<br>r la explo<br>DES para<br>egido por<br>muy prob<br>a mágica<br>(clérigo<br>AlCAnCe | njuro, el lanza<br>cuo en un lib<br>runas solo po<br>l lanzador. Si<br>zado, explotan<br>e 6 metros de<br>sión tienen de<br>reducir el dañ<br>las runas tam<br>ablemente que<br>mente contra e<br>nivel 6, dr<br>: toque CoM | dor traza unas<br>ro, pergamino,<br>drán ser leídas<br>alguien intenta<br>causando 6d6<br>diámetro. Los<br>recho a una ti-<br>o recibido a la<br>bién sufre daño<br>dará inservible<br>l fuego.<br>uida nivel 9,<br>ponentes: V y S |
| duraCión: permanente | ts: | no | rC: sí |
...
| Este conjuro proteg<br>que. Así pues, quien<br>deberá realizar una t<br>seleccionar otro obj<br>hechizo de santuario<br>convencionales, pue<br>semillas de fu<br>tl: 1 por semilla | e a la criatura<br>pretenda atac<br>irada de CAR.<br>etivo. No obst<br>no podrá con<br>s si lo hace el c<br>ego (druida<br>AlCAnCe: ver te | tocada d<br>ar a la cr<br>Si falla<br>ante, la<br>jurar ni a<br>onjuro t<br>nivel 6)<br>xto Co |
| duraCión: 1 min/nivel | ts: DES mita | d |
| El lanzador puede<br>mágicos, convirtién<br>sa manera, por ejem<br>puede lanzarse hasta<br>al blanco causando<br>depositarse en el sue<br>neas mágicas cuando<br>encontrarse a más de<br>tura afectada por es<br>por fuego. En todos<br>reducir el daño a la<br>de DES exitosa.<br>silencio (clérigo<br>tl: 1 | imbuir algun<br>dolas en armas.<br>plo, como un<br>15 metros, y<br>4d8 puntos de<br>lo, para que ar<br>lo ordene el c<br>60 metros de<br>tas llamas sufr<br>los casos, las cr<br>mitad mediant<br>nivel 2)<br>AlCAnCe: 120 m | as semill<br>Pueden<br>proyecti<br>que expl<br>daño. T<br>dan emit<br>onjurado<br>distancia<br>irá 2d8<br>iaturas a<br>e una tir<br>etros Co |
| duraCión: 1 min/nivel | ts: ver texto |  |
...
| duraCión: 1 hora/n | ivel | ts: no |
| Este conjuro cre<br>que sigue las ór<br>puertas (no atra<br>Únicamente pue<br>atravesar muros<br>aunque si el lan<br>dar órdenes al<br>vea o sepa el la<br>por debajo de u<br>lado si el lanzad<br>alguna manera.<br>de 15 metros de<br>distancia. El sir<br>sufre 1 PG por e<br>sombra de<br>tl: 1 | a una f<br>denes d<br>ncadas),<br>de carg<br>, pero<br>zador n<br>sirvient<br>nzador,<br>na pue<br>or no<br>El sirvi<br>l lanzad<br>viente p<br>fecto d<br>dragó<br>Al | uerza invisible, sin m<br>el lanzador: puede cog<br>etc. No puede luchar,<br>ar 10 kg o arrastrar 20<br>sí pasar por debajo d<br>o conoce lo que hay d<br>e. Éste no ve, ni sabe<br>de esa forma, aunqu<br>rta, no podrá abrirla<br>ha visto esa puerta ant<br>ente puede moverse h<br>or, desvaneciéndose s<br>uede ser disipado má<br>e un conjuro.<br>n (ilusionista nivel<br>CAnCe: 140 metros CoM |
| duraCión: ver te | xto | ts: INT niega |
...
| El receptor de<br>de un element<br>fuego, electrici<br>naturaleza con<br>bonificador de<br>del elemento se<br>sugestión<br>tl: 1 | este conjuro<br>o a elección d<br>dad/rayo, áci<br>vencional o<br>+2 a las tirad<br>leccionado.<br>(ilusionista n<br>AlCAnCe | queda protegido de<br>el lanzador: frío/hi<br>do y sonido/aire, y<br>mágica. El conjuro<br>as de salvación con<br>ivel 3, mago nivel<br>: 20 metros CoMpone | los efectos<br>elo, calor/<br>a sean de<br>otorga un<br>tra efectos<br>3)<br>ntes: V y S |
| duraCión: 1 hora/ | nivel ts: C | AR niega r | C: sí |
| Este conjuro p<br>de la criatura b<br>unas breves ins<br>El lanzador ha<br>instrucciones e<br>der, de lo contr<br>las instruccion<br>a sus compañer<br>efecto sobre la<br>que se alíe con<br>junta sí surtirá<br>del Narrador l<br>para el individ<br>La víctima tien<br>para evitar la s<br>sugestión<br>nivel 6)<br>tl: 1 | ermite al lan<br>lanco del con<br>trucciones a l<br>de pronuncia<br>n un lenguaje<br>ario la sugest<br>es han de ser<br>os, se suicide<br>criatura. Sin<br>el conjurado<br>efecto sobre l<br>as acciones qu<br>uo afectado).<br>e derecho a u<br>ugestión.<br>de masas<br>AlCAnCe | zador influenciar la<br>juro, el conjurador<br>a criatura y esta las<br>r en la mente de la<br>que la misma pueda<br>ión no surtirá efect<br>razonables, sugerir<br>o cosas por el estilo,<br>embargo, sugerir q<br>r para alcanzar una<br>a criatura (quedan a<br>e pueden ser o no<br>na tirada de salvació<br>(ilusionista nive<br>: 30 metros CoMpone | s acciones<br>podrá dar<br>obedecerá.<br>criatura las<br>compren-<br>o. Además,<br>que ataque<br>no tendrá<br>ue huya, o<br>meta con-<br>discreción<br>razonables<br>n de CAR<br>l 5, mago<br>ntes: V y S |
| duraCión: 1 hora/ | nivel ts: C | AR niega r | C: sí |
...
| Un par de tentáculos o<br>nos del lanzador, que<br>automáticamente causa<br>víctimas, a menos que e<br>INT. Los tentáculos dur<br>una nueva tirada de salv<br>tentáculos men<br>tl: 1 | scuros y brumo<br>puede usarlos co<br>ndo cada uno 6<br>stas superen una<br>an 2 asaltos y las<br>ación por cada a<br>ores de silas<br>AlCAnCe: 3 metros | sos crece<br>mo látig<br>puntos d<br>tirada de<br>víctimas<br>taque qu<br>(ilusion<br>CoMpo | n de las ma-<br>os. Impactan<br>e daño a sus<br>salvación de<br>pueden hacer<br>e reciban.<br>ista nivel 1)<br>nentes: V y S |
| duraCión: 2 asaltos | ts: INT niega |  | rC: sí |
| Un par de zarcillos osc<br>del lanzador, que pued<br>automáticamente causa<br>víctimas, a menos que e<br>INT. Los zarcillos dura<br>una nueva tirada de salv<br>tentáculos ver<br>nivel 4)<br>tl: 3 | uros y brumosos<br>e emplearlos co<br>ndo cada uno 3<br>stas superen una<br>n 2 asaltos y las v<br>ación por cada a<br>daderos de<br>AlCAnCe: 5 metros | crecen<br>mo látig<br>puntos d<br>tirada de<br>íctimas p<br>taque qu<br>silas<br>CoMpo | de las manos<br>os. Impactan<br>e daño a sus<br>salvación de<br>ueden hacer<br>e reciban.<br>(ilusionista<br>nentes: V y S |
| duraCión: 2 asaltos | ts: INT niega |  | rC: sí |
| Un par de tentáculos<br>manos del lanzador,<br>Impactan automáticam<br>de daño a sus víctimas<br>da de salvación de INT<br>víctimas pueden hacer<br>cada ataque que reciba<br>terremoto (cléri<br>tl: 10 min A | oscuros y bru<br>que puede empl<br>ente causando<br>, a menos que es<br>. Los tentáculos<br>una nueva tira<br>n.<br>go nivel 8, drui<br>lCAnCe: 120 metros | mosos c<br>earlos c<br>cada un<br>tas supe<br>duran 2<br>da de sa<br>da nivel<br>CoMpo | recen de las<br>omo látigos.<br>o 10 puntos<br>ren una tira-<br>asaltos y las<br>lvación por<br>9)<br>nentes: V y S |
| duraCión: 1 asalto | ts: ver texto | r | C: no |
...
| Un gran tesoro<br>dor dentro del a<br>por el conjurado<br>ver el tesoro, qu<br>armas mágicas,<br>bosar de oro. Lo<br>de INT se apres<br>y a huir en direc<br>torbellino<br>tl: 1 | aparece<br>lcance<br>r a no<br>edan en<br>objetos<br>s blanc<br>urarán<br>ción co<br>(druida<br>Al | en el punto<br>del conjuro.<br>más de 70 me<br>candiladas p<br>mágicos de<br>os que fallen<br>a tomar vario<br>ntraria hasta<br>nivel 8)<br>CAnCe: 120 met | d<br>La<br>tr<br>o<br>to<br>u<br>s<br>q<br>ro | esignado p<br>s criaturas<br>os de él, y q<br>r montones<br>do tipo y<br>na tirada d<br>objetos de<br>ue termina<br>s CoMpone |
| duraCión: 1 asalto/ | nivel | ts: ver texto |  | r |
...
| El conjurador pod<br>fuego en un área de<br>causando 1d6 pun<br>tirada de salvación<br>tormenta d<br>tl: 10 min | rá desencaden<br>3 metros cuadr<br>tos de daño p<br>exitosa de DES<br>e hielo (drui<br>AlCAnCe: 40 | ar una br<br>ados por<br>or nivel d<br>reduce el<br>da nivel<br>metros C | utal t<br>nivel d<br>el lan<br>daño<br>5, mag<br>oMpon | ormenta de<br>el lanzador,<br>zador. Una<br>a la mitad.<br>o nivel 4)<br>entes: V y S |
| duraCión: ver texto | ts: no |  | r | C: sí |
...
| Este conjuro crea un<br>en cualquier objeto<br>una puerta, un cofr<br>conjuro sobre el ob<br>objeto sea abierto p<br>palabra clave que pe<br>La explosión cubre u<br>del objeto, todas la<br>1d10 puntos de dañ<br>criaturas afectadas ti<br>de DES para reducir<br>trampa de la<br>tl: 3 | a trampa de<br>que sea suscep<br>e, una botella<br>jeto, este se<br>or cualquier c<br>rmite la apert<br>n área de 1,5<br>s criaturas de<br>o más 1 PG p<br>enen derecho<br>el daño a la<br>zo (druida<br>AlCAnCe: to | fuego que se pu<br>tible de ser cerr<br>, etc. Una vez<br>desencadenará<br>riatura que no<br>ura sin detonar<br>metros de radio<br>ntro de esta ár<br>or nivel del lan<br>a una tirada d<br>mitad.<br>nivel 3)<br>que CoMpone |
| duraCión: ver texto | ts: ver text | o rC |
...
| duraCión: 1 asalto/nivel | ts: ver texto |  | rC: sí |
| Mediante este conjur<br>trance similar al coma<br>puede realizar ninguna<br>toque tiene éxito, el cu<br>de coma mientras su<br>criatura creerá en todo<br>el mundo real.<br>Si el lanzador deja de<br>en coma hasta que ter<br>pertada con éxito. La<br>causa daño, en cuyo c<br>de salvación de INT pa<br>Si el lanzador continúa<br>despertar. Además, el co<br>víctima introduciéndos<br>interactuar con la víctim<br>la lanzándole hechizos<br>ataques de la víctima s<br>aunque a discreción del<br>al lanzador del sueño. S<br>reducen a 0, morirá. D<br>cho a realizar cualquier<br>lanzados contra ella pe<br>para resistirse a aquellos<br>información, debe aplic<br>transformar pie<br>tl: 1 | o, el lanzado<br>en la criatura<br>tirada de sal<br>erpo de la víc<br>mente comien<br>momento qu<br>tocar a la ví<br>mine el hechiz<br>víctima solo p<br>aso tiene derec<br>ra salir de su<br>tocando a la<br>njurador pued<br>e en sus sueño<br>a para obtene<br>como lo haría<br>obre el lanza<br>Narrador, pod<br>i los puntos d<br>entro del sueñ<br>tirada de salv<br>rmitirían en e<br>conjuros que<br>ar una penaliz<br>dra y mad<br>AlCAnCe: toque | r pued<br>tocada<br>vación.<br>tima ca<br>za a so<br>e sigue<br>ctima,<br>o o ha<br>uede d<br>ho a h<br>ensoña<br>víctima<br>e asalta<br>s. El co<br>r infor<br>en el<br>dor no<br>ría ser<br>e golpe<br>o, la víc<br>ación q<br>l mund<br>se utilic<br>ación d<br>era (<br>Co | e infundir un<br>. La víctima no<br>Si el ataque de<br>e en un estado<br>ñar, aunque la<br>despierta y en<br>esta permanece<br>sta que sea des-<br>espertar si se le<br>acer una tirada<br>ción.<br>, esta no puede<br>r la mente de la<br>njurador podrá<br>mación o atacar-<br>mundo real. Los<br>tendrán efecto,<br>posible expulsar<br>de la víctima se<br>tima tiene dere-<br>ue los conjuros<br>o real. Aunque,<br>en para obtener<br>e -6.<br>druida nivel 3)<br>Mponentes: V y S |
| duraCión: ver texto | ts: no |  | rC: no |
...
| Este conjuro nos pe<br>incluyendo objetos<br>tencia a conjuros de<br>convertidas en mad<br>tiradas de ataque y<br>natural de 5 o meno<br>transmutada a made<br>que reciba con un r<br>rompiéndose totalm<br>transmutar p<br>tl: 1 | rmitirá con<br>mágicos (ten<br>un objeto<br>era sufren<br>daño, y se<br>s en la tira<br>ra perderá 1<br>esultado na<br>ente con un<br>iedra y<br>AlCAnCe: 2 | vertir un objeto e<br>iendo en cuenta q<br>mágico es de 16).<br>un penalizador d<br>romperán con un<br>da de ataque. Una<br>punto de CA por<br>tural de 14 o más<br>resultado de 20 n<br>carne (mago n<br>0 metros CoMpone | n madera,<br>ue la resis-<br>Las armas<br>e -2 a las<br>resultado<br>armadura<br>cada golpe<br>en el d20,<br>atural.<br>ivel 6)<br>ntes: V y S |
| duraCión: permanente | ts: SAB | niega r | C: sí |
| Cuando el conjurad<br>una criatura petrifica<br>ra, independienteme<br>este conjuro. Asimis<br>decir, para petrificar<br>la víctima tendrá der<br>truco de la<br>nivel 2)<br>tl: 1 | or lanza es<br>da a su esta<br>nte de su ta<br>mo, puede<br>a una criatu<br>echo a una<br>cuerda<br>AlCAnCe: | te hechizo, podrá<br>do natural. Cualq<br>maño, puede ser a<br>usarse en modo<br>ra. No obstante, e<br>tirada de salvació<br>(ilusionista nive<br>toque CoMpone | devolver a<br>uier criatu-<br>fectada por<br>inverso, es<br>n este caso,<br>n de SAB.<br>l 3, mago<br>ntes: V y S |
| duraCión: 1 hora/nivel | ts: n | o rC | : no |
...
| El lanzador puede hacer<br>el lanzador pueda emiti<br>de algún otro lugar. El l<br>idioma que conozca. Cu<br>éxito en una tirada de sa<br>es una ilusión, aunque l<br>viajar mediante<br>tl: 1 Al | que su voz (o<br>r vocalmente)<br>anzador pued<br>alquiera que e<br>lvación de IN<br>o seguirá escuc<br>plantas (d<br>CAnCe: ver texto | cualq<br>parez<br>e hab<br>scuch<br>T sabr<br>hand<br>ruida<br>Co |
| duraCión: 1 asalto | ts: no |  |
| El lanzador puede intro<br>adecuado y transportars<br>misma especie y tamaño<br>distancia que las separe.<br>ra mano el punto de d<br>y distancia máximas, y<br>más cercano posible. Ta<br>destino deben estar viva<br>diante este conjuro no e<br>viajar mediante<br>tl: 1 A | ducirse en un<br>e en un asalt<br>similar, indep<br>Si el lanzador<br>estino, debe i<br>el conjuro lo<br>nto la planta d<br>s para que el c<br>s posible viaja<br>sombras (ilu<br>lCAnCe: toque | a pla<br>o a u<br>endi<br>no c<br>ndica<br>deja<br>e ori<br>onjur<br>r entr<br>sioni<br>Co |
| duraCión: 1 hora/nivel | ts: INT niega |  |
...
| duraCión: 10 min/nivel | ts: no | rC: sí |
| Este conjuro permiti<br>nes, con un rango d | rá al mago volar libre<br>e movimiento de 40 | mente sin limitacio-<br>metros cada asalto. |
